...
Public Class PaletoBlvd
    ...
    Public Shared Owner As String = ReadCfgValue("PBowner", saveFile3)
    Public Shared _Name As String = "Paleto Boulevard "
    Public Shared Desc As String = "Fall asleep to the sounds of the ocean and bums dumpster-diving in the parking lot. This cute-as-a-button property is centrally located on Paleto Bay's main street, a short walk from the coast and next door to the local supermarket. Includes 6-car garage."
    Public Shared Unit As String = "0232"
    Public Shared Cost As Integer = 121000
    Public Shared _Blip As Blip
    Public Shared Blip2 As Blip
    Public Shared Entrance As Vector3 = New Vector3(-15.24203, 6557.372, 33.24039)
    ...
    Public Shared Teleport2 As Vector3 = New Vector3(-12.83225, 6560.163, 31.97093)
    ...
    Public Shared _Garage As Vector3 = New Vector3(-12.11096, 6563.872, 31.77629)
    Public Shared GarageOut As Vector3 = New Vector3(-6.329562, 6558.033, 31.7927)
    Public Shared GarageOutHeading As Single = 225.0206
    ...
    Public Shared CameraPos As Vector3 = New Vector3(-0.02845764, 6551.444, 32.63414)
    Public Shared CameraRot As Vector3 = New Vector3(7.133693, 0, 85.69931)
    ...
    Public Sub New()
        Try
            If ReadCfgValue("PaletoBlvd", settingFile) = "Enable" Then
                _Name = ReadCfgValue("PaletoBlvdName", langFile)
                Desc = ReadCfgValue("PaletoBlvdDesc", langFile)
    ...
    Public Sub ItemSelectHandler(sender As UIMenu, selectedItem As UIMenuItem, index As Integer)
        Try
            ...
            ElseIf selectedItem.Text = SellApt Then
                'Sell Apt
                ExitMenu.Visible = False
                WriteCfgValue("PBowner", "None", saveFile3)
                SavePosition2()
                Game.FadeScreenOut(500)
                Script.Wait(&H3E8)
            ...
            ElseIf selectedItem.Text = EnterGarage Then
                ...
                SixCarGarage.LoadGarageVechicles(Application.StartupPath & "\scripts\SinglePlayerApartment\Garage\paleto_blvd\")
                SixCarGarage.CurrentPath = Application.StartupPath & "\scripts\SinglePlayerApartment\Garage\paleto_blvd\"
                ExitMenu.Visible = False
                Script.Wait(500)
                Game.FadeScreenIn(500)
        ...
        Try
            If selectedItem.Text = _Name & Unit AndAlso selectedItem.RightBadge = UIMenuItem.BadgeStyle.None AndAlso selectedItem.RightLabel = "$" & Cost.ToString("N") AndAlso Owner = "None" Then
                ...
                If playerCash > Cost Then
                    WriteCfgValue("PBowner", playerName, saveFile3)
                    Game.FadeScreenOut(500)
                    Script.Wait(&H3E8)
                    SinglePlayerApartment.player.Money = (playerCash - Cost)
                    Owner = playerName
    ...
    Public Sub GarageItemSelectHandler(sender As UIMenu, selectedItem As UIMenuItem, index As Integer)
        ...
        ElseIf selectedItem.Text = _Name & Unit & Garage AndAlso Not selectedItem.RightBadge = UIMenuItem.BadgeStyle.None AndAlso playerPed.IsInVehicle Then
            ...
            Dim path As String = Application.StartupPath & "\scripts\SinglePlayerApartment\Garage\paleto_blvd\"
            ...
            Else
                SixCarGarage.LoadGarageVechicles(Application.StartupPath & "\scripts\SinglePlayerApartment\Garage\paleto_blvd\")
                SixCarGarage.SaveGarageVehicle(Application.StartupPath & "\scripts\SinglePlayerApartment\Garage\paleto_blvd\")
            End If
        End If
    End Sub

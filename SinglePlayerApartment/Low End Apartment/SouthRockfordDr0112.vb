...
Public Class SouthRockfordDr0112
    ...
    Public Shared Owner As String = ReadCfgValue("0112SRDowner", saveFile3)
    Public Shared _Name As String = "0112 South Rockford Drive Apt. "
    Public Shared Desc As String = "This compact apartment in a 2-story apartment building has been meticulously maintained in its original condition! Semi-partial ocean view! Includes 6-car garage."
    Public Shared Unit As String = "13"
    Public Shared Cost As Integer = 80000
    Public Shared _Blip As Blip
    Public Shared Blip2 As Blip
    Public Shared Entrance As Vector3 = New Vector3(-812.3849, -980.3691, 14.26866)
    ...
    Public Shared Teleport2 As Vector3 = New Vector3(-814.8087, -984.2986, 14.03712)
    ...
    Public Shared _Garage As Vector3 = New Vector3(-812.1517, -954.1611, 15.22835)
    Public Shared GarageOut As Vector3 = New Vector3(-822.1036, -955.2672, 15.24641)
    Public Shared GarageOutHeading As Single = 99.68565
    ...
    Public Shared CameraPos As Vector3 = New Vector3(-835.3129, -1003.118, 16.48207)
    Public Shared CameraRot As Vector3 = New Vector3(3.313114, 0, -32.55415)
    ...
    Public Sub New()
        Try
            If ReadCfgValue("0112SouthRockfordDr", settingFile) = "Enable" Then
                _Name = ReadCfgValue("0112SouthRockfordName", langFile)
                Desc = ReadCfgValue("0112SouthRockfordDesc", langFile)
    ...
    Public Sub ItemSelectHandler(sender As UIMenu, selectedItem As UIMenuItem, index As Integer)
        Try
            ...
            ElseIf selectedItem.Text = SellApt Then
                'Sell Apt
                ExitMenu.Visible = False
                WriteCfgValue("0112SRDowner", "None", saveFile3)
                SavePosition2()
                Game.FadeScreenOut(500)
                Script.Wait(&H3E8)
            ...
            ElseIf selectedItem.Text = EnterGarage Then
                ...
                SixCarGarage.LoadGarageVechicles(Application.StartupPath & "\scripts\SinglePlayerApartment\Garage\0112_south_rockford_dr\")
                SixCarGarage.CurrentPath = Application.StartupPath & "\scripts\SinglePlayerApartment\Garage\0112_south_rockford_dr\"
                ExitMenu.Visible = False
                Script.Wait(500)
                Game.FadeScreenIn(500)
        ...
        Try
            If selectedItem.Text = _Name & Unit AndAlso selectedItem.RightBadge = UIMenuItem.BadgeStyle.None AndAlso selectedItem.RightLabel = "$" & Cost.ToString("N") AndAlso Owner = "None" Then
                ...
                If playerCash > Cost Then
                    WriteCfgValue("0112SRDowner", playerName, saveFile3)
                    Game.FadeScreenOut(500)
                    Script.Wait(&H3E8)
                    SinglePlayerApartment.player.Money = (playerCash - Cost)
                    Owner = playerName
    ...
    Public Sub GarageItemSelectHandler(sender As UIMenu, selectedItem As UIMenuItem, index As Integer)
        ...
        ElseIf selectedItem.Text = _Name & Unit & Garage AndAlso Not selectedItem.RightBadge = UIMenuItem.BadgeStyle.None AndAlso playerPed.IsInVehicle Then
            ...
            Dim path As String = Application.StartupPath & "\scripts\SinglePlayerApartment\Garage\0112_south_rockford_dr\"
            ...
            Else
                SixCarGarage.LoadGarageVechicles(Application.StartupPath & "\scripts\SinglePlayerApartment\Garage\0112_south_rockford_dr\")
                SixCarGarage.SaveGarageVehicle(Application.StartupPath & "\scripts\SinglePlayerApartment\Garage\0112_south_rockford_dr\")
            End If
        End If
    End Sub

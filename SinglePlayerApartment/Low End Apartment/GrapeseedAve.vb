...
Public Class GrapeseedAve
    ...
    Public Shared Owner As String = ReadCfgValue("GAowner", saveFile3)
    Public Shared _Name As String = "Grapeseed Avenue "
    Public Shared Desc As String = "Location, location, location! Across from a feed store, minimart and discount clothes emporium, this house is right in the heart of the action on Grapeseed's main drag. Living on the cutting edge of rural retail! Includes 6-car garage."
    Public Shared Unit As String = "1893"
    Public Shared Cost As Integer = 118000
    Public Shared _Blip As Blip
    Public Shared Blip2 As Blip
    Public Shared Entrance As Vector3 = New Vector3(1662.156, 4776.137, 42.01189)
    ...
    Public Shared Teleport2 As Vector3 = New Vector3(1665.579, 4776.712, 41.93869)
    ...
    Public Shared _Garage As Vector3 = New Vector3(1662.088, 4768.009, 41.79552)
    Public Shared GarageOut As Vector3 = New Vector3(1667.8, 4768.668, 41.70086)
    Public Shared GarageOutHeading As Single = 275.8229
    ...
    Public Shared CameraPos As Vector3 = New Vector3(1683.295, 4774.074, 43.80255)
    Public Shared CameraRot As Vector3 = New Vector3(-2.922752, 0, 93.5119)
    ...
    Public Sub New()
        Try
            If ReadCfgValue("GrapeseedAve", settingFile) = "Enable" Then
                _Name = ReadCfgValue("GrapeseedAveName", langFile)
                Desc = ReadCfgValue("GrapeseedAveDesc", langFile)
    ...
    Public Sub ItemSelectHandler(sender As UIMenu, selectedItem As UIMenuItem, index As Integer)
        Try
            ...
            ElseIf selectedItem.Text = SellApt Then
                'Sell Apt
                ExitMenu.Visible = False
                WriteCfgValue("GAowner", "None", saveFile3)
                SavePosition2()
                Game.FadeScreenOut(500)
                Script.Wait(&H3E8)
            ...
            ElseIf selectedItem.Text = EnterGarage Then
                ...
                SixCarGarage.LoadGarageVechicles(Application.StartupPath & "\scripts\SinglePlayerApartment\Garage\grapeseed_ave\")
                SixCarGarage.CurrentPath = Application.StartupPath & "\scripts\SinglePlayerApartment\Garage\grapeseed_ave\"
                ExitMenu.Visible = False
                Script.Wait(500)
                Game.FadeScreenIn(500)
        ...
        Try
            If selectedItem.Text = _Name & Unit AndAlso selectedItem.RightBadge = UIMenuItem.BadgeStyle.None AndAlso selectedItem.RightLabel = "$" & Cost.ToString("N") AndAlso Owner = "None" Then
                ...
                If playerCash > Cost Then
                    WriteCfgValue("GAowner", playerName, saveFile3)
                    Game.FadeScreenOut(500)
                    Script.Wait(&H3E8)
                    SinglePlayerApartment.player.Money = (playerCash - Cost)
                    Owner = playerName
    ...
    Public Sub GarageItemSelectHandler(sender As UIMenu, selectedItem As UIMenuItem, index As Integer)
        ...
        ElseIf selectedItem.Text = _Name & Unit & Garage AndAlso Not selectedItem.RightBadge = UIMenuItem.BadgeStyle.None AndAlso playerPed.IsInVehicle Then
            ...
            Dim path As String = Application.StartupPath & "\scripts\SinglePlayerApartment\Garage\grapeseed_ave\"
            ...
            Else
                SixCarGarage.LoadGarageVechicles(Application.StartupPath & "\scripts\SinglePlayerApartment\Garage\grapeseed_ave\")
                SixCarGarage.SaveGarageVehicle(Application.StartupPath & "\scripts\SinglePlayerApartment\Garage\grapeseed_ave\")
            End If
        End If
    End Sub

...
Namespace INMNative
    ...
    Public NotInheritable Class SPAVehicle
        Inherits Entity
        ...
        Public ReadOnly Property DisplayName() As String
            Get
                Return [Function].[Call](Of String)(Hash.GET_DISPLAY_NAME_FROM_VEHICLE_MODEL, MyBase.Model.Hash)
            End Get
        End Property
        ...
        Public ReadOnly Property ClassType() As VehicleClass
            Get
                Return [Function].[Call](Of VehicleClass)(Hash.GET_VEHICLE_CLASS, Handle)
            End Get
        End Property

        Public Property BodyHealth() As Single
            Get
                Return [Function].[Call](Of Single)(Hash.GET_VEHICLE_BODY_HEALTH, Handle)
            End Get
            Set
        ...
        Public Property EngineHealth() As Single
            Get
                Return [Function].[Call](Of Single)(Hash.GET_VEHICLE_ENGINE_HEALTH, Handle)
            End Get
            Set
        ...
        Public Property PetrolTankHealth() As Single
            Get
                Return [Function].[Call](Of Single)(Hash.GET_VEHICLE_PETROL_TANK_HEALTH, Handle)
            End Get
            Set
        ...
        Public Property EngineRunning() As Boolean
            Get
                Return [Function].[Call](Of Boolean)(Hash._IS_VEHICLE_ENGINE_ON, Handle)
            End Get
            Set
        ...
        Public Property Speed() As Single
            Get
                Return [Function].[Call](Of Single)(Hash.GET_ENTITY_SPEED, Handle)
            End Get
            Set
        ...
        Public ReadOnly Property AlarmActive() As Boolean
            Get
                Return [Function].[Call](Of Boolean)(Hash.IS_VEHICLE_ALARM_ACTIVATED, Handle)
            End Get
        End Property
        ...
        Public Property SirenActive() As Boolean
            Get
                Return [Function].[Call](Of Boolean)(Hash.IS_VEHICLE_SIREN_ON, Handle)
            End Get
            Set
        ...
        Public Property Livery() As Integer
            Get
                ...
                Return [Function].[Call](Of Integer)(Hash.GET_VEHICLE_LIVERY, Handle)
            End Get
            Set
        ...
        Public ReadOnly Property LiveryCount() As Integer
            Get
                ...
                Return [Function].[Call](Of Integer)(Hash.GET_VEHICLE_LIVERY_COUNT, Handle)
            End Get
        End Property
        ...
        Public Property LightsOn() As Boolean
            ...
            End Get
            Set
                [Function].[Call](Hash.SET_VEHICLE_LIGHTS, Handle, If(Value, 3, 4))
            End Set
        End Property
        ...
        Public Property SearchLightOn() As Boolean
            Get
                Return [Function].[Call](Of Boolean)(Hash.IS_VEHICLE_SEARCHLIGHT_ON, Handle)
            End Get
            Set
        ...
        Public Property TaxiLightOn() As Boolean
            Get
                Return [Function].[Call](Of Boolean)(Hash.IS_TAXI_LIGHT_ON, Handle)
            End Get
            Set
        ...
        Public ReadOnly Property IsDamaged() As Boolean
            Get
                Return [Function].[Call](Of Boolean)(Hash._IS_VEHICLE_DAMAGED, Handle)
            End Get
        End Property
        Public Property IsDriveable() As Boolean
            Get
                Return [Function].[Call](Of Boolean)(Hash.IS_VEHICLE_DRIVEABLE, Handle, 0)
            End Get
            Set
                [Function].[Call](Hash.SET_VEHICLE_UNDRIVEABLE, Handle, Not Value)
            End Set
        End Property
        Public ReadOnly Property HasRoof() As Boolean
            Get
                Return [Function].[Call](Of Boolean)(Hash.DOES_VEHICLE_HAVE_ROOF, Handle)
            End Get
        End Property

        Public ReadOnly Property IsRearBumperBrokenOff() As Boolean
            Get
                Return [Function].[Call](Of Boolean)(Hash.IS_VEHICLE_BUMPER_BROKEN_OFF, Handle, False)
            End Get
        End Property
        Public ReadOnly Property IsFrontBumperBrokenOff() As Boolean
            Get
                Return [Function].[Call](Of Boolean)(Hash.IS_VEHICLE_BUMPER_BROKEN_OFF, Handle, True)
            End Get
        End Property

        Public WriteOnly Property IsAxlesStrong() As Boolean
            Set
                [Function].[Call](Of Boolean)(Hash.SET_VEHICLE_HAS_STRONG_AXLES, Handle, Value)
            End Set
        End Property
        ...
        Public Property WheelType() As VehicleWheelType
            Get
                Return [Function].[Call](Of VehicleWheelType)(Hash.GET_VEHICLE_WHEEL_TYPE, Handle)
            End Get
            Set
        ...
        Public Property WindowTint() As VehicleWindowTint
            Get
                Return [Function].[Call](Of VehicleWindowTint)(Hash.GET_VEHICLE_WINDOW_TINT, Handle)
            End Get
            Set
        ...
        Public Property PrimaryColor() As VehicleColor
            Get
                Dim color1 = New OutputArgument()
                Dim color2 = New OutputArgument()
        ...
        Public Property TrimColor() As VehicleColor
            Get
                Dim color = New OutputArgument()
                [Function].[Call](DirectCast(9012939617897488694UL, Hash), Handle, color)

                Return color.GetResult(Of VehicleColor)()
            End Get
            Set
                [Function].[Call](DirectCast(17585947422526242585UL, Hash), Handle, Value)
            End Set
        End Property
        Public Property DashboardColor() As VehicleColor
            Get
                Dim color = New OutputArgument()
                [Function].[Call](DirectCast(13214509638265019391UL, Hash), Handle, color)

                Return color.GetResult(Of VehicleColor)()
            End Get
            Set
                [Function].[Call](DirectCast(6956317558672667244UL, Hash), Handle, Value)
            End Set
        End Property
        Public Property ColorCombination() As Integer
            Get
                Return [Function].[Call](Of Integer)(Hash.GET_VEHICLE_COLOUR_COMBINATION, Handle)
            End Get
            Set
        ...
        Public ReadOnly Property ColorCombinationCount() As Integer
            Get
                Return [Function].[Call](Of Integer)(Hash.GET_NUMBER_OF_VEHICLE_COLOURS, Handle)
            End Get
        End Property
        ...
        Public ReadOnly Property IsPrimaryColorCustom() As Boolean
            Get
                Return [Function].[Call](Of Boolean)(Hash.GET_IS_VEHICLE_PRIMARY_COLOUR_CUSTOM, Handle)
            End Get
        End Property
        Public ReadOnly Property IsSecondaryColorCustom() As Boolean
            Get
                Return [Function].[Call](Of Boolean)(Hash.GET_IS_VEHICLE_SECONDARY_COLOUR_CUSTOM, Handle)
            End Get
        End Property
        ...
        Public Property NumberPlateType() As NumberPlateType
            Get
                Return [Function].[Call](Of NumberPlateType)(Hash.GET_VEHICLE_NUMBER_PLATE_TEXT_INDEX, Handle)
            End Get
            Set
        ...
        Public ReadOnly Property NumberPlateMounting() As NumberPlateMounting
            Get
                Return [Function].[Call](Of NumberPlateMounting)(Hash.GET_VEHICLE_PLATE_TYPE, Handle)
            End Get
        End Property
        Public Property NumberPlate() As String
            Get
                Return [Function].[Call](Of String)(Hash.GET_VEHICLE_NUMBER_PLATE_TEXT, Handle)
            End Get
            Set
        ...
        Public Property LandingGear() As VehicleLandingGear
            Get
                Return [Function].[Call](Of VehicleLandingGear)(Hash._GET_VEHICLE_LANDING_GEAR, Handle)
            End Get
            Set
        ...
        Public Property RoofState() As VehicleRoofState
            Get
                Return [Function].[Call](Of VehicleRoofState)(Hash.GET_CONVERTIBLE_ROOF_STATE, Handle)
            End Get
            Set
                Select Case Value
        ...
        Public Property LockStatus() As VehicleLockStatus
            Get
                Return [Function].[Call](Of VehicleLockStatus)(Hash.GET_VEHICLE_DOOR_LOCK_STATUS, Handle)
            End Get
            Set
        ...
        Public ReadOnly Property MaxBraking() As Single
            Get
                Return [Function].[Call](Of Single)(Hash.GET_VEHICLE_MAX_BRAKING, Handle)
            End Get
        End Property
        Public ReadOnly Property MaxTraction() As Single
            Get
                Return [Function].[Call](Of Single)(Hash.GET_VEHICLE_MAX_TRACTION, Handle)
            End Get
        End Property
        ...
        Public ReadOnly Property IsOnAllWheels() As Boolean
            ...
            Get
                Return [Function].[Call](Of Boolean)(Hash.IS_VEHICLE_ON_ALL_WHEELS, Handle)
            End Get
        End Property
        ...
        Public ReadOnly Property IsStopped() As Boolean
            ...
            Get
                Return [Function].[Call](Of Boolean)(Hash.IS_VEHICLE_STOPPED, Handle)
            End Get
        End Property
        Public ReadOnly Property IsStoppedAtTrafficLights() As Boolean

            Get
                Return [Function].[Call](Of Boolean)(Hash.IS_VEHICLE_STOPPED_AT_TRAFFIC_LIGHTS, Handle)
            End Get
        End Property

        Public Property IsStolen() As Boolean
            Get
                Return [Function].[Call](Of Boolean)(Hash.IS_VEHICLE_STOLEN, Handle)
            End Get
            Set
        ...
        Public ReadOnly Property IsConvertible() As Boolean
            ...
            Get
                Return [Function].[Call](Of Boolean)(Hash.IS_VEHICLE_A_CONVERTIBLE, Handle, 0)
            End Get
        End Property

        Public Function IsInBurnout() As Boolean
            Return [Function].[Call](Of Boolean)(Hash.IS_VEHICLE_IN_BURNOUT, Handle)
        End Function
        ...
        Public ReadOnly Property PassengerSeats() As Integer
            Get
                Return [Function].[Call](Of Integer)(Hash.GET_VEHICLE_MAX_NUMBER_OF_PASSENGERS, Handle)
            End Get
        End Property
        Public ReadOnly Property PassengerCount() As Integer
            Get
                Return [Function].[Call](Of Integer)(Hash.GET_VEHICLE_NUMBER_OF_PASSENGERS, Handle)
            End Get
        End Property
        ...
        Public Function GetMod(modType As VehicleMod) As Integer
            Return [Function].[Call](Of Integer)(Hash.GET_VEHICLE_MOD, Handle, modType)
        End Function
        ...
        Public Function GetModCount(modType As VehicleMod) As Integer
            Return [Function].[Call](Of Integer)(Hash.GET_NUM_VEHICLE_MODS, Handle, modType)
        End Function
        Public Sub ToggleMod(toggleMod__1 As VehicleToggleMod, toggle As Boolean)
            [Function].[Call](Hash.TOGGLE_VEHICLE_MOD, Handle, toggleMod__1, toggle)
        End Sub
        Public Function IsToggleModOn(toggleMod As VehicleToggleMod) As Boolean
            Return [Function].[Call](Of Boolean)(Hash.IS_TOGGLE_MOD_ON, Handle, toggleMod)
        End Function
        Public Function GetModTypeName(modType As VehicleMod) As String
            Return [Function].[Call](Of String)(Hash.GET_MOD_SLOT_NAME, Handle, modType)
        End Function
        Public Function GetToggleModTypeName(toggleModType As VehicleToggleMod) As String
            Return [Function].[Call](Of String)(Hash.GET_MOD_SLOT_NAME, Handle, toggleModType)
        End Function
        Public Function GetModName(modType As VehicleMod, modValue As Integer) As String
            Return [Function].[Call](Of String)(Hash.GET_MOD_TEXT_LABEL, Handle, modType, modValue)
        End Function

        Public Function ExtraExists(extra As Integer) As Boolean
            Return [Function].[Call](Of Boolean)(Hash.DOES_EXTRA_EXIST, Handle, extra)
        End Function
        Public Function IsExtraOn(extra As Integer) As Boolean
            Return [Function].[Call](Of Boolean)(Hash.IS_VEHICLE_EXTRA_TURNED_ON, Handle, extra)
        End Function
        Public Sub ToggleExtra(extra As Integer, toggle As Boolean)
            [Function].[Call](Hash.SET_VEHICLE_EXTRA, Handle, extra, Not toggle)
        End Sub

        Public Function GetPedOnSeat(seat As VehicleSeat) As Ped
            Return New Ped([Function].[Call](Of Integer)(Hash.GET_PED_IN_VEHICLE_SEAT, Handle, seat))
        End Function
        Public Function IsSeatFree(seat As VehicleSeat) As Boolean
            Return [Function].[Call](Of Boolean)(Hash.IS_VEHICLE_SEAT_FREE, Handle, seat)
        End Function
        ...
        Public Property DirtLevel() As Single
            Get
                Return [Function].[Call](Of Single)(Hash.GET_VEHICLE_DIRT_LEVEL, Handle)
            End Get
            Set
        ...
        Public Function PlaceOnGround() As Boolean
            Return [Function].[Call](Of Boolean)(Hash.SET_VEHICLE_ON_GROUND_PROPERLY, Handle)
        End Function
        Public Sub PlaceOnNextStreet()
            ...
            For i As Integer = 1 To 39
                [Function].[Call](Hash.GET_NTH_CLOSEST_VEHICLE_NODE_WITH_HEADING, currentPosition.X, currentPosition.Y, currentPosition.Z, i, newPositionArg,
                headingArg, New OutputArgument(), 1, &H40400000, 0)

                Dim newPosition = newPositionArg.GetResult(Of Vector3)()

                If Not [Function].[Call](Of Boolean)(Hash.IS_POINT_OBSCURED_BY_A_MISSION_ENTITY, newPosition.X, newPosition.Y, newPosition.Z, 5.0F, 5.0F,
                5.0F, 0) Then
        ...
        Public Property CanTiresBurst() As Boolean
            Get
                Return [Function].[Call](Of Boolean)(Hash.GET_VEHICLE_TYRES_CAN_BURST, Handle)
            End Get
            Set
        ...
        Public Function IsTireBurst(wheel As Integer) As Boolean
            Return [Function].[Call](Of Boolean)(Hash.IS_VEHICLE_TYRE_BURST, Handle, wheel, False)
        End Function
        ...
        Public Function IsDoorBroken(door As VehicleDoor) As Boolean
            Return [Function].[Call](Of Boolean)(Hash.IS_VEHICLE_DOOR_DAMAGED, Handle, door)
        End Function
        ...
        Public Function GetDoorAngleRatio(door As VehicleDoor) As Single
            Return [Function].[Call](Of Single)(Hash.GET_VEHICLE_DOOR_ANGLE_RATIO, Handle, door)
        End Function
        ...
        Public Function IsNeonLightsOn(light As VehicleNeonLight) As Boolean
            Return [Function].[Call](Of Boolean)(Hash._IS_VEHICLE_NEON_LIGHT_ENABLED, Handle, light)
        End Function
        ...
        Public Function IsCargobobHookActive() As Boolean
            If Model.IsCargobob Then
                Return [Function].[Call](Of Boolean)(Hash._IS_CARGOBOB_HOOK_ACTIVE, Handle) OrElse [Function].[Call](Of Boolean)(Hash._IS_CARGOBOB_MAGNET_ACTIVE, Handle)
            End If
            ...
            If Model.IsCargobob Then
                Select Case hook
                    Case CargobobHook.Hook
                        Return [Function].[Call](Of Boolean)(Hash._IS_CARGOBOB_HOOK_ACTIVE, Handle)
                    Case CargobobHook.Magnet
                        Return [Function].[Call](Of Boolean)(Hash._IS_CARGOBOB_MAGNET_ACTIVE, Handle)
                End Select
            End If
        ...
        Public ReadOnly Property TowedVehicle() As Vehicle
            Get
                Return New Vehicle([Function].[Call](Of Integer)(Hash.GET_ENTITY_ATTACHED_TO_TOW_TRUCK, Handle))
            End Get
        End Property
        Public Sub TowVehicle(vehicle As Vehicle, rear As Boolean)
            [Function].[Call](Hash.ATTACH_VEHICLE_TO_TOW_TRUCK, Handle, vehicle.Handle, rear, 0F, 0F,
            0F)
        End Sub
        ...
        Public Function CreatePedOnSeat(seat As VehicleSeat, model As Model) As Ped
            ...
            Return New Ped([Function].[Call](Of Integer)(Hash.CREATE_PED_INSIDE_VEHICLE, Handle, 26, model.Hash, seat, 1,
            1))
        End Function
        Public Function CreateRandomPedOnSeat(seat As VehicleSeat) As Ped
            If seat = VehicleSeat.Driver Then
                Return New Ped([Function].[Call](Of Integer)(Hash.CREATE_RANDOM_PED_AS_DRIVER, Handle, True))
            Else
                Dim pedHandle As Integer = [Function].[Call](Of Integer)(Hash.CREATE_RANDOM_PED, 0F, 0F, 0F)

...
Public Class SanAndreasAve7302
    Inherits Script

    Public Shared Owner As String = ReadCfgValue("7302SAAowner", saveFile4)
    ...
    Public Shared Cost As Integer = 396000
    Public Shared _Blip As Blip
    Public Shared Blip2 As Blip
    Public Shared Entrance As Vector3 = New Vector3(-467.068, -679.5209, 32.71051)
    Public Shared Save As Vector3 = New Vector3(-474.3249, -711.4752, 47.19847)
    Public Shared Teleport As Vector3 = New Vector3(-477.3131, -695.3513, 53.4058)
    Public Shared Teleport2 As Vector3 = New Vector3(-467.9712, -676.9213, 32.71631)
    Public Shared _Exit As Vector3 = New Vector3(-477.0502, -692.209, 53.3058)
    Public Shared Wardrobe As Vector3 = New Vector3(-468.7397, -710.7102, 47.20931)
    Public Shared _Garage As Vector3 = New Vector3(-504.8584, -741.2202, 32.11877)
    Public Shared GarageOut As Vector3 = New Vector3(-505.0308, -749.8248, 31.78029)
    Public Shared GarageOutHeading As Single = 180.1597
    ...
    Public Shared CameraPos As Vector3 = New Vector3(-405.692, -648.4352, 48.057)
    Public Shared CameraRot As Vector3 = New Vector3(7.220088, 0, 126.9862)
    Public Shared CameraFov As Single = 50.0
    Public Shared WardrobeHeading As Single = 358.5104
    ...
    Public Sub New()
        Try
            If ReadCfgValue("7302SanAndreasAve", settingFile) = "Enable" Then
                _Name = ReadCfgValue("7302SanAndreasAveName", langFile)
                Desc = ReadCfgValue("7302SanAndreasAveDesc", langFile)
                SanAndreasAve7302_2._Name = ReadCfgValue("7302SanAndreasAve2Name", langFile)
                SanAndreasAve7302_2.Desc = ReadCfgValue("7302SanAndreasAve2Desc", langFile)
    ...
    Public Shared Sub CreateBuyMenu()
        Try
            ...
            Dim item2 As New UIMenuItem(SanAndreasAve7302_2._Name & SanAndreasAve7302_2.Unit, SanAndreasAve7302_2.Desc)
            With item2
                If SanAndreasAve7302_2.Owner = "Michael" Then
                    .SetRightBadge(UIMenuItem.BadgeStyle.Michael)
                ElseIf SanAndreasAve7302_2.Owner = "Franklin" Then
                    .SetRightBadge(UIMenuItem.BadgeStyle.Franklin)
                ElseIf SanAndreasAve7302_2.Owner = "Trevor" Then
                    .SetRightBadge(UIMenuItem.BadgeStyle.Trevor)
                ElseIf SanAndreasAve7302_2.Owner = "Player3" Then
                    .SetRightBadge(UIMenuItem.BadgeStyle.Heart)
                Else
                    .SetRightLabel("$" & SanAndreasAve7302_2.Cost.ToString("N"))
                    .SetRightBadge(UIMenuItem.BadgeStyle.None)
                End If
    ...
    Public Shared Sub RefreshGarageMenu()
        ...
        Dim item2 As New UIMenuItem(SanAndreasAve7302_2._Name & SanAndreasAve7302_2.Unit & Garage)
        With item2
            If SanAndreasAve7302_2.Owner = "Michael" Then
                .SetRightBadge(UIMenuItem.BadgeStyle.Michael)
            ElseIf SanAndreasAve7302_2.Owner = "Franklin" Then
    ...
    Public Shared Sub Create7302SanAndreasAve()
        _Blip = World.CreateBlip(Entrance)
        If Owner = "Michael" AndAlso SanAndreasAve7302_2.Owner = "Michael" Then
        ...
        ElseIf Owner = "Franklin" AndAlso SanAndreasAve7302_2.Owner = "Franklin" Then
            _Blip.Sprite = BlipSprite.Safehouse
            ...
            Blip2.IsShortRange = True
            SetBlipName(_Name & Garage, Blip2)
        ElseIf Owner = "Trevor" AndAlso SanAndreasAve7302_2.Owner = "Trevor" Then
            _Blip.Sprite = BlipSprite.Safehouse
            _Blip.Color = 17
            _Blip.IsShortRange = True
            SetBlipName(_Name, _Blip)
            ...
            Blip2.IsShortRange = True
            SetBlipName(_Name & Garage, Blip2)
        ElseIf Owner = "Player3" AndAlso SanAndreasAve7302_2.Owner = "Player3" Then
            _Blip.Sprite = BlipSprite.Safehouse
            ...
            Blip2.IsShortRange = True
            SetBlipName(_Name & Garage, Blip2)
        ElseIf Owner <> SanAndreasAve7302_2.Owner Then
            _Blip.Sprite = BlipSprite.Safehouse
    ...
    Public Sub ItemSelectHandler(sender As UIMenu, selectedItem As UIMenuItem, index As Integer)
        Try
            ...
            ElseIf selectedItem.Text = SellApt Then
                'Sell Apt
                ExitMenu.Visible = False
                WriteCfgValue("7302SAAowner", "None", saveFile4)
                SavePosition2()
                Game.FadeScreenOut(500)
                Wait(&H3E8)
            ...
            ElseIf selectedItem.Text = EnterGarage Then
                ...
                TenCarGarage.LoadGarageVechicles(Application.StartupPath & "\scripts\SinglePlayerApartment\Garage\7302_san_andreas_ave\")
                TenCarGarage.CurrentPath = Application.StartupPath & "\scripts\SinglePlayerApartment\Garage\7302_san_andreas_ave\"
                ExitMenu.Visible = False
                Wait(500)
                Game.FadeScreenIn(500)
            End If
        ...
        Try
            If selectedItem.Text = _Name & Unit AndAlso selectedItem.RightBadge = UIMenuItem.BadgeStyle.None AndAlso selectedItem.RightLabel = "$" & Cost.ToString("N") AndAlso Owner = "None" Then
                ...
                If playerCash > Cost Then
                    WriteCfgValue("7302SAAowner", playerName, saveFile4)
                    Game.FadeScreenOut(500)
                    Wait(&H3E8)
                    SinglePlayerApartment.player.Money = (playerCash - Cost)
                    Owner = playerName
            ...
            ElseIf selectedItem.Text = _Name & Unit AndAlso Not selectedItem.RightBadge = UIMenuItem.BadgeStyle.None AndAlso Owner = playerName Then
                ...
                SetInteriorActive2(-477.221924, -693.967834, 53.4057999) '7302 SanAndreas Ave
                Game.FadeScreenOut(500)
                Wait(&H3E8)
            ...
            '4 Integrity Way HL
            If selectedItem.Text = SanAndreasAve7302_2._Name & SanAndreasAve7302_2.Unit AndAlso selectedItem.RightBadge = UIMenuItem.BadgeStyle.None AndAlso selectedItem.RightLabel = "$" & SanAndreasAve7302_2.Cost.ToString("N") AndAlso SanAndreasAve7302_2.Owner = "None" Then
                'Buy Apartment
                If playerCash > SanAndreasAve7302_2.Cost Then
                    WriteCfgValue("7302SAA2owner", playerName, saveFile4)
                    Game.FadeScreenOut(500)
                    Wait(&H3E8)
                    SinglePlayerApartment.player.Money = (playerCash - Cost)
                    SanAndreasAve7302_2.Owner = playerName
                    _Blip.Remove()
                    If Not Blip2 Is Nothing Then Blip2.Remove()
                    Create7302SanAndreasAve()
                    RefreshGarageMenu()
                    ...
                    Game.FadeScreenIn(500)
                    Native.Function.Call(Hash.PLAY_SOUND_FRONTEND, -1, "PROPERTY_PURCHASE", "HUD_AWARDS", False)
                    BigMessageThread.MessageInstance.ShowWeaponPurchasedMessage("~y~" & PropPurchased, "~w~" & SanAndreasAve7302_2._Name & SanAndreasAve7302_2.Unit, Nothing)
                    If playerName = "Michael" Then
                        selectedItem.SetRightBadge(UIMenuItem.BadgeStyle.Michael)
                    ElseIf playerName = "Franklin" Then
                        selectedItem.SetRightBadge(UIMenuItem.BadgeStyle.Franklin)
                ...
                Else
                    ...
                    End If
                End If
            ElseIf selectedItem.Text = SanAndreasAve7302_2._Name & SanAndreasAve7302_2.Unit AndAlso Not selectedItem.RightBadge = UIMenuItem.BadgeStyle.None AndAlso SanAndreasAve7302_2.Owner = playerName Then
                'Enter Apartment
                BuyMenu.Visible = False
                hideHud = False
                World.DestroyAllCameras()
                ...
                SetInteriorActive2(-459.006042, -704.304871, 77.0868835) '7302 SanAndreas Ave 2
                Game.FadeScreenOut(500)
                Wait(&H3E8)
                Game.Player.Character.Position = SanAndreasAve7302_2.Teleport
                Wait(500)
                Game.FadeScreenIn(500)
            End If
        Catch ex As Exception
    ...
    Public Sub GarageItemSelectHandler(sender As UIMenu, selectedItem As UIMenuItem, index As Integer)
        If selectedItem.Text = _Name & Unit & Garage AndAlso Not selectedItem.RightBadge = UIMenuItem.BadgeStyle.None AndAlso Not playerPed.IsInVehicle AndAlso Owner = playerName Then
            ...
            Wait(&H3E8)
            SetInteriorActive2(222.592, -968.1, -99) '10 car garage
            SetInteriorActive2(-477.221924, -693.967834, 53.4057999) '7302 San Andreas Ave
        ...
        ElseIf selectedItem.Text = _Name & Unit & Garage AndAlso Not selectedItem.RightBadge = UIMenuItem.BadgeStyle.None AndAlso playerPed.IsInVehicle AndAlso Owner = playerName Then
            ...
            Dim path As String = Application.StartupPath & "\scripts\SinglePlayerApartment\Garage\7302_san_andreas_ave\"
            ...
            Else
                TenCarGarage.LoadGarageVechicles(Application.StartupPath & "\scripts\SinglePlayerApartment\Garage\7302_san_andreas_ave\")
                TenCarGarage.SaveGarageVehicle(Application.StartupPath & "\scripts\SinglePlayerApartment\Garage\7302_san_andreas_ave\")
            End If
        ElseIf selectedItem.Text = SanAndreasAve7302_2._Name & SanAndreasAve7302_2.Unit & Garage AndAlso Not selectedItem.RightBadge = UIMenuItem.BadgeStyle.None AndAlso Not playerPed.IsInVehicle AndAlso SanAndreasAve7302_2.Owner = playerName Then
            'Teleport to Garage
            If My.Settings.AlwaysEnableMPMaps = False Then LoadMPDLCMap()
            IsAtHome = True
            ...
            Wait(&H3E8)
            SetInteriorActive2(222.592, -968.1, -99) '10 car garage
            SetInteriorActive2(-459.006042, -704.304871, 77.0868835) '7302 San Andreas Ave 2
            playerPed.Position = TenCarGarage.GarageDoorL
            TenCarGarage.LastLocationName = SanAndreasAve7302_2._Name & SanAndreasAve7302_2.Unit
            TenCarGarage.lastLocationVector = SanAndreasAve7302_2._Exit
            TenCarGarage.lastLocationGarageVector = _Garage
            TenCarGarage.lastLocationGarageOutVector = GarageOut
            TenCarGarage.lastLocationGarageOutHeading = GarageOutHeading
            ...
            Wait(500)
            Game.FadeScreenIn(500)
        ElseIf selectedItem.Text = SanAndreasAve7302_2._Name & SanAndreasAve7302_2.Unit & Garage AndAlso Not selectedItem.RightBadge = UIMenuItem.BadgeStyle.None AndAlso playerPed.IsInVehicle AndAlso SanAndreasAve7302_2.Owner = playerName Then
            On Error Resume Next
            Dim VehPlate0, VehPlate1, VehPlate2, VehPlate3, VehPlate4, VehPlate5, VehPlate6, VehPlate7, VehPlate8, VehPlate9 As String
            Dim path As String = Application.StartupPath & "\scripts\SinglePlayerApartment\Garage\7302_san_andreas_ave_2\"
            If IO.File.Exists(path & "vehicle_0.cfg") Then VehPlate0 = ReadCfgValue("PlateNumber", path & "vehicle_0.cfg") Else VehPlate0 = "0"
            If IO.File.Exists(path & "vehicle_1.cfg") Then VehPlate1 = ReadCfgValue("PlateNumber", path & "vehicle_1.cfg") Else VehPlate1 = "0"
            If IO.File.Exists(path & "vehicle_2.cfg") Then VehPlate2 = ReadCfgValue("PlateNumber", path & "vehicle_2.cfg") Else VehPlate2 = "0"
            If IO.File.Exists(path & "vehicle_3.cfg") Then VehPlate3 = ReadCfgValue("PlateNumber", path & "vehicle_3.cfg") Else VehPlate3 = "0"
            ...
            Else
                TenCarGarage.LoadGarageVechicles(Application.StartupPath & "\scripts\SinglePlayerApartment\Garage\7302_san_andreas_ave_2\")
                TenCarGarage.SaveGarageVehicle(Application.StartupPath & "\scripts\SinglePlayerApartment\Garage\7302_san_andreas_ave_2\")
            End If
        End If
    End Sub
    ...
    Public Sub OnTick(o As Object, e As EventArgs)
        Try
            If My.Settings.SanAndreasAve7302 = "Enable" Then
                ...
                'Enter Garage
                If (Not playerPed.IsDead AndAlso (Owner = playerName Or SanAndreasAve7302_2.Owner = playerName)) AndAlso GarageDistance < 5.0 Then
    ...
    Public Sub HIDE_MAP_OBJECT_THIS_FRAME()
        ...
        Native.Function.Call(Hash._HIDE_MAP_OBJECT_THIS_FRAME, Native.Function.Call(Of Integer)(Hash.GET_HASH_KEY, "kt1_09_building1"))
        Native.Function.Call(Hash._HIDE_MAP_OBJECT_THIS_FRAME, Native.Function.Call(Of Integer)(Hash.GET_HASH_KEY, "kt1_09_kt1_emissive_ema"))

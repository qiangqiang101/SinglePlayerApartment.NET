...
Public Class RichardMajestic
    ...
    Public Sub New()
        Try
            Apartment = New Apartment(Game.GetGXTEntry("MP_PROP_40"), 484000, Game.GetGXTEntry("MP_PROP_40DES"))
            Apartment.Owner = AptRichardMajesticOwner
            ...
            Apartment.GaragePath = "scripts\SinglePlayerApartment\Garage\richard_majestic\"
            ...
            ApartmentHL = New Apartment(Game.GetGXTEntry("MP_PROP_69"), 968000, Game.GetGXTEntry("MP_PROP_69DES"))
            ApartmentHL.Owner = AptRichardMajesticOwner2
            ...
            ApartmentHL.GaragePath = "scripts\SinglePlayerApartment\Garage\richard_majestic_hl\"
    ...
    Public Sub ItemSelectHandler(sender As UIMenu, selectedItem As UIMenuItem, index As Integer)
        Try
            ...
            ElseIf selectedItem.Text = SellApt Then
                'Sell Apt
                ExitMenu.Visible = False
                AptRichardMajesticOwner = UpdateValue(Of Owner)(owners, richardmajestic1, Owner.None)
                SavePosition2()
                Game.FadeScreenOut(500)
                Wait(500)
    ...
    Public Sub HLItemSelectHandler(sender As UIMenu, selectedItem As UIMenuItem, index As Integer)
        Try
            ...
            ElseIf selectedItem.Text = SellApt Then
                'Sell Apt
                ExitMenuHL.Visible = False
                AptRichardMajesticOwner2 = UpdateValue(Of Owner)(owners, richardmajestic2, Owner.None)
                SavePosition2()
                Game.FadeScreenOut(500)
                Wait(500)
        ...
        Try
            If selectedItem.Text = Apartment.Name AndAlso selectedItem.RightBadge = UIMenuItem.BadgeStyle.None AndAlso selectedItem.RightLabel = "$" & Apartment.Cost.ToString("N") AndAlso Apartment.Owner = Owner.None Then
                ...
                If playerCash > Apartment.Cost Then
                    AptRichardMajesticOwner = UpdateValue(Of Owner)(owners, richardmajestic1, GetOwner)
                    Game.FadeScreenOut(500)
                    Wait(500)
            ...
            If selectedItem.Text = ApartmentHL.Name AndAlso selectedItem.RightBadge = UIMenuItem.BadgeStyle.None AndAlso selectedItem.RightLabel = "$" & ApartmentHL.Cost.ToString("N") AndAlso ApartmentHL.Owner = Owner.None Then
                ...
                If playerCash > ApartmentHL.Cost Then
                    AptRichardMajesticOwner2 = UpdateValue(Of Owner)(owners, richardmajestic2, GetOwner)
                    Game.FadeScreenOut(500)
                    Wait(500)
        ...
        Try
            If Not Game.IsLoading Then
                If AptRichardMajestic Then
                    ...
                    'Enter Garage
                    If (Not playerPed.IsDead AndAlso (Apartment.Owner = GetOwner() Or ApartmentHL.Owner = GetOwner())) AndAlso Apartment.GarageDistance < 5.0 Then

...
Public Class NorthConker2045
    ...
    Public Sub New()
        Try
            Apartment = New Apartment(Game.GetGXTEntry("MP_PROP_95"), 727000, Game.GetGXTEntry("MP_PROP_95DES"))
            Apartment.Owner = Apt2045NorthConkerOwner
            ...
            Apartment.GaragePath = "scripts\SinglePlayerApartment\Garage\2045_north_conker\"
    ...
    Public Sub ItemSelectHandler(sender As UIMenu, selectedItem As UIMenuItem, index As Integer)
        Try
            ...
            ElseIf selectedItem.Text = SellApt Then
                'Sell Apt
                ExitMenu.Visible = False
                Apt2045NorthConkerOwner = UpdateValue(Of Owner)(owners, MySave.northconker2045, Owner.None)
                SavePosition2()
                Game.FadeScreenOut(500)
                Wait(500)
        ...
        Try
            If selectedItem.Text = Apartment.Name AndAlso selectedItem.RightBadge = UIMenuItem.BadgeStyle.None AndAlso selectedItem.RightLabel = "$" & Apartment.Cost.ToString("N") AndAlso Apartment.Owner = Owner.None Then
                ...
                If playerCash > Apartment.Cost Then
                    Apt2045NorthConkerOwner = UpdateValue(Of Owner)(owners, MySave.northconker2045, GetOwner)
                    Game.FadeScreenOut(500)
                    Wait(500)

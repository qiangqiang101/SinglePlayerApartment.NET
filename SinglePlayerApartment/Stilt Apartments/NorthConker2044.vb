...
Public Class NorthConker2044
    ...
    Public Sub New()
        Try
            Apartment = New Apartment(Game.GetGXTEntry("MP_PROP_84"), 762000, Game.GetGXTEntry("MP_PROP_84DES"))
            Apartment.Owner = Apt2044NorthConkerOwner
            ...
            Apartment.GaragePath = "scripts\SinglePlayerApartment\Garage\2044_north_conker\"
    ...
    Public Sub ItemSelectHandler(sender As UIMenu, selectedItem As UIMenuItem, index As Integer)
        Try
            ...
            ElseIf selectedItem.Text = SellApt Then
                'Sell Apt
                ExitMenu.Visible = False
                Apt2044NorthConkerOwner = UpdateValue(Of Owner)(owners, MySave.northconker2044, Owner.None)
                SavePosition2()
                Game.FadeScreenOut(500)
                Wait(500)
        ...
        Try
            If selectedItem.Text = Apartment.Name AndAlso selectedItem.RightBadge = UIMenuItem.BadgeStyle.None AndAlso selectedItem.RightLabel = "$" & Apartment.Cost.ToString("N") AndAlso Apartment.Owner = Owner.None Then
                ...
                If playerCash > Apartment.Cost Then
                    Apt2044NorthConkerOwner = UpdateValue(Of Owner)(owners, MySave.northconker2044, GetOwner)
                    Game.FadeScreenOut(500)
                    Wait(500)

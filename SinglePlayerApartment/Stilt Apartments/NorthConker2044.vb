...
Public Class NorthConker2044
    ...
    Public Shared Owner As String = ReadCfgValue("2044NCowner", saveFile2)
    Public Shared _Name As String = "North Conker Avenue "
    Public Shared Desc As String = "San Andreas is a place where property values can only go up and high magnitude earthquakes never happen, so where better to balance a luxury apartment on stilits over a steep hillside in a crowded residential area? The first time you feel yourself and everything you own sway in a light breeze and you'll be surprised how good this sounded on paper. Includes 10-car garage."
    Public Shared Unit As String = "2044"
    Public Shared Cost As Integer = 762000
    Public Shared _Blip As Blip
    Public Shared Blip2 As Blip
    Public Shared Entrance As Vector3 = New Vector3(346.4214, 440.7363, 147.7075)
    Public Shared Save As Vector3 = New Vector3(332.7306, 423.6146, 145.5968)
    Public Shared Teleport As Vector3 = New Vector3(340.6531, 436.7456, 149.394)
    Public Shared Teleport2 As Vector3 = New Vector3(349.893, 442.8174, 147.3472)
    Public Shared _Exit As Vector3 = New Vector3(342.1347, 437.8865, 149.3808)
    Public Shared Wardrobe As Vector3 = New Vector3(334.2987, 428.6485, 145.5708)
    Public Shared _Garage As Vector3 = New Vector3(352.814, 437.2492, 146.3828)
    Public Shared GarageOut As Vector3 = New Vector3(356.54, 439.226, 145.098)
    Public Shared GarageOutHeading As Single = 294.08
    ...
    Public Shared CameraPos As Vector3 = New Vector3(347.726, 459.0123, 150.3243)
    Public Shared CameraRot As Vector3 = New Vector3(-3.703, 0, 161.5176)
    Public Shared CameraFov As Single = 50.0
    Public Shared WardrobeHeading As Single = 103.0573
        ...
        Try
            If ReadCfgValue("2044NorthConker", settingFile) = "Enable" Then
                ...
                If uiLanguage = "Chinese" Then
                    _Name = "板栗大街北段 "
                    Desc = "聖安地列斯是個房價只高不低，但永遠不會 ~n~ 發生大地震的地方，所以諾要建造奢華的架 ~n~ 高式公寓，還有哪個地點會比這片堆擠住宅 ~n~ 區的陡峭山坡地更合適？當你頭一次感覺到 ~n~ 自己與擁有的一切在微風中搖擺，就會對以上 ~n~ 描述的一切管好感到訝異了。 ~n~ 包括可容納十輛車的車庫。"
                    Garage = "車庫"
                Else
    ...
    Public Sub ItemSelectHandler(sender As UIMenu, selectedItem As UIMenuItem, index As Integer)
        Try
            ...
            ElseIf selectedItem.Text = SellApt Then
                'Sell Apt
                ExitMenu.Visible = False
                WriteCfgValue("2044NCowner", "None", saveFile2)
                SavePosition2()
                Game.FadeScreenOut(500)
                Script.Wait(&H3E8)
            ...
            ElseIf selectedItem.Text = EnterGarage Then
                ...
                TenCarGarage.LoadGarageVechicles(Application.StartupPath & "\scripts\SinglePlayerApartment\Garage\2044_north_conker\")
                TenCarGarage.CurrentPath = Application.StartupPath & "\scripts\SinglePlayerApartment\Garage\2044_north_conker\"
                ExitMenu.Visible = False
                Script.Wait(500)
                Game.FadeScreenIn(500)
            End If
        ...
        Try
            If selectedItem.Text = _Name & Unit AndAlso selectedItem.RightBadge = UIMenuItem.BadgeStyle.None AndAlso selectedItem.RightLabel = "$" & Cost.ToString("N") AndAlso Owner = "None" Then
                ...
                If playerCash > Cost Then
                    WriteCfgValue("2044NCowner", playerName, saveFile2)
                    Game.FadeScreenOut(500)
                    Script.Wait(&H3E8)
                    SinglePlayerApartment.player.Money = (playerCash - Cost)
                    Owner = playerName
    ...
    Public Sub GarageItemSelectHandler(sender As UIMenu, selectedItem As UIMenuItem, index As Integer)
        ...
        ElseIf selectedItem.Text = _Name & Unit & Garage AndAlso Not selectedItem.RightBadge = UIMenuItem.BadgeStyle.None AndAlso playerPed.IsInVehicle Then
            ...
            Dim path As String = Application.StartupPath & "\scripts\SinglePlayerApartment\Garage\2044_north_conker\"
            ...
            Else
                TenCarGarage.LoadGarageVechicles(Application.StartupPath & "\scripts\SinglePlayerApartment\Garage\2044_north_conker\")
                TenCarGarage.SaveGarageVehicle(Application.StartupPath & "\scripts\SinglePlayerApartment\Garage\2044_north_conker\")
            End If
        End If
    End Sub
    ...
    Public Sub HIDE_MAP_OBJECT_THIS_FRAME()
        ...
        Native.Function.Call(Hash._0xA97F257D0151A6AB, Native.Function.Call(Of Integer)(Hash.GET_HASH_KEY, "apa_ch2_04_house02"))
        Native.Function.Call(Hash._0xA97F257D0151A6AB, Native.Function.Call(Of Integer)(Hash.GET_HASH_KEY, "apa_ch2_04_house02_d"))
        Native.Function.Call(Hash._0xA97F257D0151A6AB, Native.Function.Call(Of Integer)(Hash.GET_HASH_KEY, "apa_ch2_04_M_a_LOD"))
        Native.Function.Call(Hash._0xA97F257D0151A6AB, Native.Function.Call(Of Integer)(Hash.GET_HASH_KEY, "ch2_04_house02_railings"))
        Native.Function.Call(Hash._0xA97F257D0151A6AB, Native.Function.Call(Of Integer)(Hash.GET_HASH_KEY, "ch2_04_emissive_04"))
        Native.Function.Call(Hash._0xA97F257D0151A6AB, Native.Function.Call(Of Integer)(Hash.GET_HASH_KEY, "ch2_04_emissive_04_LOD"))
        Native.Function.Call(Hash._0xA97F257D0151A6AB, Native.Function.Call(Of Integer)(Hash.GET_HASH_KEY, "apa_ch2_04_house02_details"))

...
Public Class Whispymound3677
    ...
    Public Sub New()
        Try
            Apartment = New Apartment(Game.GetGXTEntry("MP_PROP_87"), 478000, Game.GetGXTEntry("MP_PROP_87DES"))
            Apartment.Owner = Apt3677WhispymoundOwner
            ...
            Apartment.GaragePath = "scripts\SinglePlayerApartment\Garage\3677_whispymound\"
    ...
    Public Sub ItemSelectHandler(sender As UIMenu, selectedItem As UIMenuItem, index As Integer)
        Try
            ...
            ElseIf selectedItem.Text = SellApt Then
                'Sell Apt
                ExitMenu.Visible = False
                Apt3677WhispymoundOwner = UpdateValue(Of Owner)(owners, whispymound, Owner.None)
                SavePosition2()
                Game.FadeScreenOut(500)
                Wait(500)
        ...
        Try
            If selectedItem.Text = Apartment.Name AndAlso selectedItem.RightBadge = UIMenuItem.BadgeStyle.None AndAlso selectedItem.RightLabel = "$" & Apartment.Cost.ToString("N") AndAlso Apartment.Owner = Owner.None Then
                ...
                If playerCash > Apartment.Cost Then
                    Apt3677WhispymoundOwner = UpdateValue(Of Owner)(owners, whispymound, GetOwner)
                    Game.FadeScreenOut(500)
                    Wait(500)

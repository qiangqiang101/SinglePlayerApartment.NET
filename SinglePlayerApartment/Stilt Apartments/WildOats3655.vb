...
Public Class WildOats3655
    ...
    Public Sub New()
        Try
            Apartment = New Apartment(Game.GetGXTEntry("MP_PROP_83"), 800000, Game.GetGXTEntry("MP_PROP_83DES"))
            Apartment.Owner = Apt3655WildOatsOwner
            ...
            Apartment.GaragePath = "scripts\SinglePlayerApartment\Garage\3655_wild_oats\"
    ...
    Public Sub ItemSelectHandler(sender As UIMenu, selectedItem As UIMenuItem, index As Integer)
        Try
            ...
            ElseIf selectedItem.Text = SellApt Then
                'Sell Apt
                ExitMenu.Visible = False
                Apt3655WildOatsOwner = UpdateValue(Of Owner)(owners, wildoats, Owner.None)
                SavePosition2()
                Game.FadeScreenOut(500)
                Wait(500)
        ...
        Try
            If selectedItem.Text = Apartment.Name AndAlso selectedItem.RightBadge = UIMenuItem.BadgeStyle.None AndAlso selectedItem.RightLabel = "$" & Apartment.Cost.ToString("N") AndAlso Apartment.Owner = Owner.None Then
                ...
                If playerCash > Apartment.Cost Then
                    Apt3655WildOatsOwner = UpdateValue(Of Owner)(owners, wildoats, GetOwner)
                    Game.FadeScreenOut(500)
                    Wait(500)

...
Public Class MiltonRd2117
    ...
    Public Sub New()
        Try
            Apartment = New Apartment(Game.GetGXTEntry("MP_PROP_89"), 608000, Game.GetGXTEntry("MP_PROP_89DES"))
            Apartment.Owner = Apt2117MiltonRdOwner
            ...
            Apartment.GaragePath = "scripts\SinglePlayerApartment\Garage\2117_milton_road\"
    ...
    Public Sub ItemSelectHandler(sender As UIMenu, selectedItem As UIMenuItem, index As Integer)
        Try
            ...
            ElseIf selectedItem.Text = SellApt Then
                'Sell Apt
                ExitMenu.Visible = False
                Apt2117MiltonRdOwner = UpdateValue(Of Owner)(owners, MySave.miltonrd2117, Owner.None)
                SavePosition2()
                Game.FadeScreenOut(500)
                Wait(500)
        ...
        Try
            If selectedItem.Text = Apartment.Name AndAlso selectedItem.RightBadge = UIMenuItem.BadgeStyle.None AndAlso selectedItem.RightLabel = "$" & Apartment.Cost.ToString("N") AndAlso Apartment.Owner = Owner.None Then
                ...
                If playerCash > Apartment.Cost Then
                    Apt2117MiltonRdOwner = UpdateValue(Of Owner)(owners, MySave.miltonrd2117, GetOwner)
                    Game.FadeScreenOut(500)
                    Wait(500)

...
Public Class HillcrestAve2862
    ...
    Public Sub New()
        Try
            Apartment = New Apartment(Game.GetGXTEntry("MP_PROP_86"), 705000, Game.GetGXTEntry("MP_PROP_86DES"))
            Apartment.Owner = Apt2862HillcrestOwner
            ...
            Apartment.GaragePath = "scripts\SinglePlayerApartment\Garage\2862_hillcreast_ave\"
    ...
    Public Sub ItemSelectHandler(sender As UIMenu, selectedItem As UIMenuItem, index As Integer)
        Try
            ...
            ElseIf selectedItem.Text = SellApt Then
                'Sell Apt
                ExitMenu.Visible = False
                Apt2862HillcrestOwner = UpdateValue(Of Owner)(owners, hillcrest2862, Owner.None)
                SavePosition2()
                Game.FadeScreenOut(500)
                Wait(500)
        ...
        Try
            If selectedItem.Text = Apartment.Name AndAlso selectedItem.RightBadge = UIMenuItem.BadgeStyle.None AndAlso selectedItem.RightLabel = "$" & Apartment.Cost.ToString("N") AndAlso Apartment.Owner = Owner.None Then
                ...
                If playerCash > Apartment.Cost Then
                    Apt2862HillcrestOwner = UpdateValue(Of Owner)(owners, hillcrest2862, GetOwner)
                    Game.FadeScreenOut(500)
                    Wait(500)

...
Public Class MadWayne2113
    ...
    Public Sub New()
        Try
            Apartment = New Apartment(Game.GetGXTEntry("MP_PROP_94"), 449000, Game.GetGXTEntry("MP_PROP_94DES"))
            Apartment.Owner = Apt2113MadWayneOwner
            ...
            Apartment.GaragePath = "scripts\SinglePlayerApartment\Garage\2113_mad_wayne\"
    ...
    Public Sub ItemSelectHandler(sender As UIMenu, selectedItem As UIMenuItem, index As Integer)
        Try
            ...
            ElseIf selectedItem.Text = SellApt Then
                'Sell Apt
                ExitMenu.Visible = False
                Apt2113MadWayneOwner = UpdateValue(Of Owner)(owners, madwayne, Owner.None)
                SavePosition2()
                Game.FadeScreenOut(500)
                Wait(500)
        ...
        Try
            If selectedItem.Text = Apartment.Name AndAlso selectedItem.RightBadge = UIMenuItem.BadgeStyle.None AndAlso selectedItem.RightLabel = "$" & Apartment.Cost.ToString("N") AndAlso Apartment.Owner = Owner.None Then
                ...
                If playerCash > Apartment.Cost Then
                    Apt2113MadWayneOwner = UpdateValue(Of Owner)(owners, madwayne, GetOwner)
                    Game.FadeScreenOut(500)
                    Wait(500)

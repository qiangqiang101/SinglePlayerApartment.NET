...
Public Class MiltonRd0184
    ...
    Public Shared Owner As String = ReadCfgValue("0184MRowner", saveFile3)
    Public Shared _Name As String = "0184 Milton Road Apt. "
    Public Shared Desc As String = "Cozy one-bedroom in a cute West Vinewood apartment block! You'll only share the building with a few other units, meaning fewer neighbors for you to grow to despise. Includes 10-car garage."
    Public Shared Unit As String = "13"
    Public Shared Cost As Integer = 146000
    Public Shared _Blip As Blip
    Public Shared Blip2 As Blip
    Public Shared Entrance As Vector3 = New Vector3(-511.7496, 108.2573, 63.80054)
    ...
    Public Shared Teleport2 As Vector3 = New Vector3(-512.2141, 111.8229, 63.33881)
    ...
    Public Shared _Garage As Vector3 = New Vector3(-521.9894, 92.31882, 59.75345)
    Public Shared GarageOut As Vector3 = New Vector3(-536.3447, 92.78167, 60.42566)
    Public Shared GarageOutHeading As Single = 87.18483
    ...
    Public Shared CameraPos As Vector3 = New Vector3(-526.9971, 133.2838, 65.28127)
    Public Shared CameraRot As Vector3 = New Vector3(5.028964, 0, -148.544)
    ...
    Public Sub New()
        Try
            If ReadCfgValue("0184MiltonRd", settingFile) = "Enable" Then
                _Name = ReadCfgValue("MiltonRdName", langFile)
                Desc = ReadCfgValue("MiltonRdDesc", langFile)
    ...
    Public Sub ItemSelectHandler(sender As UIMenu, selectedItem As UIMenuItem, index As Integer)
        Try
            ...
            ElseIf selectedItem.Text = SellApt Then
                'Sell Apt
                ExitMenu.Visible = False
                WriteCfgValue("0184MRowner", "None", saveFile3)
                SavePosition2()
                Game.FadeScreenOut(500)
                Wait(&H3E8)
            ...
            ElseIf selectedItem.Text = EnterGarage Then
                ...
                TenCarGarage.LoadGarageVechicles(Application.StartupPath & "\scripts\SinglePlayerApartment\Garage\0184_milton_road\")
                TenCarGarage.CurrentPath = Application.StartupPath & "\scripts\SinglePlayerApartment\Garage\0184_milton_road\"
                ExitMenu.Visible = False
                Wait(500)
                Game.FadeScreenIn(500)
        ...
        Try
            If selectedItem.Text = _Name & Unit AndAlso selectedItem.RightBadge = UIMenuItem.BadgeStyle.None AndAlso selectedItem.RightLabel = "$" & Cost.ToString("N") AndAlso Owner = "None" Then
                ...
                If playerCash > Cost Then
                    WriteCfgValue("0184MRowner", playerName, saveFile3)
                    Game.FadeScreenOut(500)
                    Wait(&H3E8)
                    SinglePlayerApartment.player.Money = (playerCash - Cost)
                    Owner = playerName
    ...
    Public Sub GarageItemSelectHandler(sender As UIMenu, selectedItem As UIMenuItem, index As Integer)
        ...
        ElseIf selectedItem.Text = _Name & Unit & Garage AndAlso Not selectedItem.RightBadge = UIMenuItem.BadgeStyle.None AndAlso playerPed.IsInVehicle Then
            ...
            Dim path As String = Application.StartupPath & "\scripts\SinglePlayerApartment\Garage\0184_milton_road\"
            ...
            Else
                TenCarGarage.LoadGarageVechicles(Application.StartupPath & "\scripts\SinglePlayerApartment\Garage\0184_milton_road\")
                TenCarGarage.SaveGarageVehicle(Application.StartupPath & "\scripts\SinglePlayerApartment\Garage\0184_milton_road\")
            End If
        End If
    End Sub

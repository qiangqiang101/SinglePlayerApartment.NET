...
Public Class SpanishAve
    ...
    Public Shared Owner As String = ReadCfgValue("SAonwer", saveFile3)
    Public Shared _Name As String = "0605 Spanish Avenue Apt. "
    Public Shared Desc As String = "This newly-renovated one-bedroom in Downtown Vinewood is a STEAL! Hurry this one won't last! It did last! $10,000 price reduction! Crazy value! Move NOW the price is right! Everything's negotiable. Motivated seller. Reduced again for quick sale! Will someone just buy this already??? Includes 10-car garage."
    Public Shared Unit As String = "1"
    Public Shared Cost As Integer = 128000
    Public Shared _Blip As Blip
    Public Shared Blip2 As Blip
    Public Shared Entrance As Vector3 = New Vector3(3.602079, 37.2024, 71.53042)
    ...
    Public Shared Teleport2 As Vector3 = New Vector3(2.387458, 34.19853, 71.16882)
    ...
    Public Shared _Garage As Vector3 = New Vector3(-11.9249, 37.897, 71.08931)
    Public Shared GarageOut As Vector3 = New Vector3(-12.86958, 35.41181, 71.03293)
    Public Shared GarageOutHeading As Single = 158.7376
    ...
    Public Shared CameraPos As Vector3 = New Vector3(-23.84228, 11.21701, 74.10461)
    Public Shared CameraRot As Vector3 = New Vector3(10.09729, 0, -29.36126)
    ...
    Public Sub New()
        Try
            If ReadCfgValue("SpanishAve", settingFile) = "Enable" Then
                _Name = ReadCfgValue("SpanishAveName", langFile)
                Desc = ReadCfgValue("SpanishAveDesc", langFile)
    ...
    Public Sub ItemSelectHandler(sender As UIMenu, selectedItem As UIMenuItem, index As Integer)
        Try
            ...
            ElseIf selectedItem.Text = SellApt Then
                'Sell Apt
                ExitMenu.Visible = False
                WriteCfgValue("SAonwer", "None", saveFile3)
                SavePosition2()
                Game.FadeScreenOut(500)
                Wait(&H3E8)
            ...
            ElseIf selectedItem.Text = EnterGarage Then
                ...
                TenCarGarage.LoadGarageVechicles(Application.StartupPath & "\scripts\SinglePlayerApartment\Garage\spanish_ave\")
                TenCarGarage.CurrentPath = Application.StartupPath & "\scripts\SinglePlayerApartment\Garage\spanish_ave\"
                ExitMenu.Visible = False
                Wait(500)
                Game.FadeScreenIn(500)
        ...
        Try
            If selectedItem.Text = _Name & Unit AndAlso selectedItem.RightBadge = UIMenuItem.BadgeStyle.None AndAlso selectedItem.RightLabel = "$" & Cost.ToString("N") AndAlso Owner = "None" Then
                ...
                If playerCash > Cost Then
                    WriteCfgValue("SAonwer", playerName, saveFile3)
                    Game.FadeScreenOut(500)
                    Wait(&H3E8)
                    SinglePlayerApartment.player.Money = (playerCash - Cost)
                    Owner = playerName
    ...
    Public Sub GarageItemSelectHandler(sender As UIMenu, selectedItem As UIMenuItem, index As Integer)
        ...
        ElseIf selectedItem.Text = _Name & Unit & Garage AndAlso Not selectedItem.RightBadge = UIMenuItem.BadgeStyle.None AndAlso playerPed.IsInVehicle Then
            ...
            Dim path As String = Application.StartupPath & "\scripts\SinglePlayerApartment\Garage\spanish_ave\"
            ...
            Else
                TenCarGarage.LoadGarageVechicles(Application.StartupPath & "\scripts\SinglePlayerApartment\Garage\spanish_ave\")
                TenCarGarage.SaveGarageVehicle(Application.StartupPath & "\scripts\SinglePlayerApartment\Garage\spanish_ave\")
            End If
        End If
    End Sub

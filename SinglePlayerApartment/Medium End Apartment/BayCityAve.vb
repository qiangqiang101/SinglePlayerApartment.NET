...
Public Class BayCityAve
    ...
    Public Shared Owner As String = ReadCfgValue("BCAowner", saveFile3)
    Public Shared _Name As String = "0115 Bay City Avenue Apt. "
    Public Shared Desc As String = "Hello sailor! This renovated, fully-furnished apartment is right on the waterfront in Puerto Del Sol Yacht Club. Perfect for picking up other sailors. Includes 10-car garage."
    Public Shared Unit As String = "45"
    Public Shared Cost As Integer = 150000
    Public Shared _Blip As Blip
    Public Shared Blip2 As Blip
    Public Shared Entrance As Vector3 = New Vector3(-969.2759, -1431.104, 7.763627)
    ...
    Public Shared Teleport2 As Vector3 = New Vector3(-974.1464, -1433.113, 7.679172)
    ...
    Public Shared _Garage As Vector3 = New Vector3(-982.9502, -1450.931, 4.38989)
    Public Shared GarageOut As Vector3 = New Vector3(-993.4175, -1425.568, 4.386545)
    Public Shared GarageOutHeading As Single = 107.4124
    ...
    Public Shared CameraPos As Vector3 = New Vector3(-1012.979, -1429.618, 6.07423)
    Public Shared CameraRot As Vector3 = New Vector3(9.87174, 0, -98.14085)
    ...
    Public Sub New()
        Try
            If ReadCfgValue("BayCityAve", settingFile) = "Enable" Then
                _Name = ReadCfgValue("BayCityName", langFile)
                Desc = ReadCfgValue("BayCityDesc", langFile)
    ...
    Public Sub ItemSelectHandler(sender As UIMenu, selectedItem As UIMenuItem, index As Integer)
        Try
            ...
            ElseIf selectedItem.Text = SellApt Then
                'Sell Apt
                ExitMenu.Visible = False
                WriteCfgValue("BCAowner", "None", saveFile3)
                SavePosition2()
                Game.FadeScreenOut(500)
                Wait(&H3E8)
            ...
            ElseIf selectedItem.Text = EnterGarage Then
                ...
                TenCarGarage.LoadGarageVechicles(Application.StartupPath & "\scripts\SinglePlayerApartment\Garage\bay_city_ave\")
                TenCarGarage.CurrentPath = Application.StartupPath & "\scripts\SinglePlayerApartment\Garage\bay_city_ave\"
                ExitMenu.Visible = False
                Wait(500)
                Game.FadeScreenIn(500)
        ...
        Try
            If selectedItem.Text = _Name & Unit AndAlso selectedItem.RightBadge = UIMenuItem.BadgeStyle.None AndAlso selectedItem.RightLabel = "$" & Cost.ToString("N") AndAlso Owner = "None" Then
                ...
                If playerCash > Cost Then
                    WriteCfgValue("BCAowner", playerName, saveFile3)
                    Game.FadeScreenOut(500)
                    Wait(&H3E8)
                    SinglePlayerApartment.player.Money = (playerCash - Cost)
                    Owner = playerName
    ...
    Public Sub GarageItemSelectHandler(sender As UIMenu, selectedItem As UIMenuItem, index As Integer)
        ...
        ElseIf selectedItem.Text = _Name & Unit & Garage AndAlso Not selectedItem.RightBadge = UIMenuItem.BadgeStyle.None AndAlso playerPed.IsInVehicle Then
            ...
            Dim path As String = Application.StartupPath & "\scripts\SinglePlayerApartment\Garage\bay_city_ave\"
            ...
            Else
                TenCarGarage.LoadGarageVechicles(Application.StartupPath & "\scripts\SinglePlayerApartment\Garage\bay_city_ave\")
                TenCarGarage.SaveGarageVehicle(Application.StartupPath & "\scripts\SinglePlayerApartment\Garage\bay_city_ave\")
            End If
        End If
    End Sub

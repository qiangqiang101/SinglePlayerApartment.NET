...
Public Class LasLagunasBlvd0604
    ...
    Public Shared Owner As String = ReadCfgValue("0604LLBowner", saveFile3)
    Public Shared _Name As String = "0604 Las Lagunas Boulevard Apt. "
    Public Shared Desc As String = "This building has seen better days - the closest thing to a doorman is a homeless guy you sometimes have to step over to get into the lobby at night - but how else are you going to find a Vinewood apartment in your price range? Hope you like the smell of urine. Includes 10-car garage."
    Public Shared Unit As String = "4"
    Public Shared Cost As Integer = 126000
    Public Shared _Blip As Blip
    Public Shared Blip2 As Blip
    Public Shared Entrance As Vector3 = New Vector3(9.446668, 81.46045, 78.43513)
    ...
    Public Shared Teleport2 As Vector3 = New Vector3(10.9781, 86.45157, 78.39816)
    ...
    Public Shared _Garage As Vector3 = New Vector3(27.83206, 80.46669, 74.25099)
    Public Shared GarageOut As Vector3 = New Vector3(39.44078, 77.11552, 74.9635)
    Public Shared GarageOutHeading As Single = 241.9727
    ...
    Public Shared CameraPos As Vector3 = New Vector3(-31.15757, 105.2271, 81.74537)
    Public Shared CameraRot As Vector3 = New Vector3(6.371637, 0, -137.1451)
    ...
    Public Sub New()
        Try
            If ReadCfgValue("0604LasLagunasBlvd", settingFile) = "Enable" Then
                _Name = ReadCfgValue("0604LasLagunasName", langFile)
                Desc = ReadCfgValue("0604LasLagunasDesc", langFile)
    ...
    Public Sub ItemSelectHandler(sender As UIMenu, selectedItem As UIMenuItem, index As Integer)
        Try
            ...
            ElseIf selectedItem.Text = SellApt Then
                'Sell Apt
                ExitMenu.Visible = False
                WriteCfgValue("0604LLBowner", "None", saveFile3)
                SavePosition2()
                Game.FadeScreenOut(500)
                Wait(&H3E8)
            ...
            ElseIf selectedItem.Text = EnterGarage Then
                ...
                TenCarGarage.LoadGarageVechicles(Application.StartupPath & "\scripts\SinglePlayerApartment\Garage\0604_las_lagunas_blvd\")
                TenCarGarage.CurrentPath = Application.StartupPath & "\scripts\SinglePlayerApartment\Garage\0604_las_lagunas_blvd\"
                ExitMenu.Visible = False
                Wait(500)
                Game.FadeScreenIn(500)
        ...
        Try
            If selectedItem.Text = _Name & Unit AndAlso selectedItem.RightBadge = UIMenuItem.BadgeStyle.None AndAlso selectedItem.RightLabel = "$" & Cost.ToString("N") AndAlso Owner = "None" Then
                ...
                If playerCash > Cost Then
                    WriteCfgValue("0604LLBowner", playerName, saveFile3)
                    Game.FadeScreenOut(500)
                    Wait(&H3E8)
                    SinglePlayerApartment.player.Money = (playerCash - Cost)
                    Owner = playerName
    ...
    Public Sub GarageItemSelectHandler(sender As UIMenu, selectedItem As UIMenuItem, index As Integer)
        ...
        ElseIf selectedItem.Text = _Name & Unit & Garage AndAlso Not selectedItem.RightBadge = UIMenuItem.BadgeStyle.None AndAlso playerPed.IsInVehicle Then
            ...
            Dim path As String = Application.StartupPath & "\scripts\SinglePlayerApartment\Garage\0604_las_lagunas_blvd\"
            ...
            Else
                TenCarGarage.LoadGarageVechicles(Application.StartupPath & "\scripts\SinglePlayerApartment\Garage\0604_las_lagunas_blvd\")
                TenCarGarage.SaveGarageVehicle(Application.StartupPath & "\scripts\SinglePlayerApartment\Garage\0604_las_lagunas_blvd\")
            End If
        End If
    End Sub

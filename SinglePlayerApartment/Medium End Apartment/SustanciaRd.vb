...
Public Class SustanciaRd
    ...
    Public Shared Owner As String = ReadCfgValue("SRowner", saveFile3)
    Public Shared _Name As String = "Sustancia Road "
    Public Shared Desc As String = "Calling all gentrifers... El Burro Heights is ripe for hostile takeover! Pack up the espresso machine, labradoodle and deliberately tousled toddler and snap up this property before it's too late! Act now, or you'll be priced out of this neighborhood within a year! Includes 10-car garage."
    Public Shared Unit As String = "12"
    Public Shared Cost As Integer = 143000
    Public Shared _Blip As Blip
    Public Shared Blip2 As Blip
    Public Shared Entrance As Vector3 = New Vector3(1341.38, -1577.858, 54.44421)
    ...
    Public Shared Teleport2 As Vector3 = New Vector3(1344.532, -1581.023, 54.05513)
    ...
    Public Shared _Garage As Vector3 = New Vector3(1351.739, -1574.466, 53.83353)
    Public Shared GarageOut As Vector3 = New Vector3(1354.933, -1578.982, 53.38385)
    Public Shared GarageOutHeading As Single = 216.5491
    ...
    Public Shared CameraPos As Vector3 = New Vector3(1357.432, -1594.719, 53.01324)
    Public Shared CameraRot As Vector3 = New Vector3(3.356584, 0, 35.79725)
    ...
    Public Sub New()
        Try
            If ReadCfgValue("SustanciaRd", settingFile) = "Enable" Then
                _Name = ReadCfgValue("SustanciaRdName", langFile)
                Desc = ReadCfgValue("SustanciaRdDesc", langFile)
    ...
    Public Sub ItemSelectHandler(sender As UIMenu, selectedItem As UIMenuItem, index As Integer)
        Try
            ...
            ElseIf selectedItem.Text = SellApt Then
                'Sell Apt
                ExitMenu.Visible = False
                WriteCfgValue("SRowner", "None", saveFile3)
                SavePosition2()
                Game.FadeScreenOut(500)
                Wait(&H3E8)
            ...
            ElseIf selectedItem.Text = EnterGarage Then
                ...
                TenCarGarage.LoadGarageVechicles(Application.StartupPath & "\scripts\SinglePlayerApartment\Garage\sustancia_rd\")
                TenCarGarage.CurrentPath = Application.StartupPath & "\scripts\SinglePlayerApartment\Garage\sustancia_rd\"
                ExitMenu.Visible = False
                Wait(500)
                Game.FadeScreenIn(500)
        ...
        Try
            If selectedItem.Text = _Name & Unit AndAlso selectedItem.RightBadge = UIMenuItem.BadgeStyle.None AndAlso selectedItem.RightLabel = "$" & Cost.ToString("N") AndAlso Owner = "None" Then
                ...
                If playerCash > Cost Then
                    WriteCfgValue("SRowner", playerName, saveFile3)
                    Game.FadeScreenOut(500)
                    Wait(&H3E8)
                    SinglePlayerApartment.player.Money = (playerCash - Cost)
                    Owner = playerName
    ...
    Public Sub GarageItemSelectHandler(sender As UIMenu, selectedItem As UIMenuItem, index As Integer)
        ...
        ElseIf selectedItem.Text = _Name & Unit & Garage AndAlso Not selectedItem.RightBadge = UIMenuItem.BadgeStyle.None AndAlso playerPed.IsInVehicle Then
            ...
            Dim path As String = Application.StartupPath & "\scripts\SinglePlayerApartment\Garage\sustancia_rd\"
            ...
            Else
                TenCarGarage.LoadGarageVechicles(Application.StartupPath & "\scripts\SinglePlayerApartment\Garage\sustancia_rd\")
                TenCarGarage.SaveGarageVehicle(Application.StartupPath & "\scripts\SinglePlayerApartment\Garage\sustancia_rd\")
            End If
        End If
    End Sub

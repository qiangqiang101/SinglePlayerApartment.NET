...
Public Class ProcopioDr4584
    ...
    Public Shared Owner As String = ReadCfgValue("4584PDowner", saveFile3)
    Public Shared _Name As String = "Procopio Drive "
    Public Shared Desc As String = "Check out the water feature in the front yard! This is coastal, provincial living at its very finest. Worried about shade? Want easy access to groceries? How about two for the price of one? This house backs right onto the supermarket, blocking out all natural light. Includes 10-car garage."
    Public Shared Unit As String = "4584"
    Public Shared Cost As Integer = 155000
    Public Shared _Blip As Blip
    Public Shared Blip2 As Blip
    Public Shared Entrance As Vector3 = New Vector3(-105.6365, 6528.601, 30.16694)
    ...
    Public Shared Teleport2 As Vector3 = New Vector3(-108.5332, 6531.883, 29.80916)
    ...
    Public Shared _Garage As Vector3 = New Vector3(-105.0798, 6534.642, 29.56255)
    Public Shared GarageOut As Vector3 = New Vector3(-108.9384, 6538.451, 29.60509)
    Public Shared GarageOutHeading As Single = 47.39733
    ...
    Public Shared CameraPos As Vector3 = New Vector3(-114.0698, 6545.125, 30.18196)
    Public Shared CameraRot As Vector3 = New Vector3(-1.917315, 0, -155.1204)
    ...
    Public Sub New()
        Try
            If ReadCfgValue("4584ProcopioDr", settingFile) = "Enable" Then
                _Name = ReadCfgValue("4584ProcopioDrName", langFile)
                Desc = ReadCfgValue("4584ProcopioDrDesc", langFile)
    ...
    Public Sub ItemSelectHandler(sender As UIMenu, selectedItem As UIMenuItem, index As Integer)
        Try
            ...
            ElseIf selectedItem.Text = SellApt Then
                'Sell Apt
                ExitMenu.Visible = False
                WriteCfgValue("4584PDowner", "None", saveFile3)
                SavePosition2()
                Game.FadeScreenOut(500)
                Wait(&H3E8)
            ...
            ElseIf selectedItem.Text = EnterGarage Then
                ...
                TenCarGarage.LoadGarageVechicles(Application.StartupPath & "\scripts\SinglePlayerApartment\Garage\4584_procopio_dr\")
                TenCarGarage.CurrentPath = Application.StartupPath & "\scripts\SinglePlayerApartment\Garage\4584_procopio_dr\"
                ExitMenu.Visible = False
                Wait(500)
                Game.FadeScreenIn(500)
        ...
        Try
            If selectedItem.Text = _Name & Unit AndAlso selectedItem.RightBadge = UIMenuItem.BadgeStyle.None AndAlso selectedItem.RightLabel = "$" & Cost.ToString("N") AndAlso Owner = "None" Then
                ...
                If playerCash > Cost Then
                    WriteCfgValue("4584PDowner", playerName, saveFile3)
                    Game.FadeScreenOut(500)
                    Wait(&H3E8)
                    SinglePlayerApartment.player.Money = (playerCash - Cost)
                    Owner = playerName
    ...
    Public Sub GarageItemSelectHandler(sender As UIMenu, selectedItem As UIMenuItem, index As Integer)
        ...
        ElseIf selectedItem.Text = _Name & Unit & Garage AndAlso Not selectedItem.RightBadge = UIMenuItem.BadgeStyle.None AndAlso playerPed.IsInVehicle Then
            ...
            Dim path As String = Application.StartupPath & "\scripts\SinglePlayerApartment\Garage\4584_procopio_dr\"
            ...
            Else
                TenCarGarage.LoadGarageVechicles(Application.StartupPath & "\scripts\SinglePlayerApartment\Garage\4584_procopio_dr\")
                TenCarGarage.SaveGarageVehicle(Application.StartupPath & "\scripts\SinglePlayerApartment\Garage\4584_procopio_dr\")
            End If
        End If
    End Sub

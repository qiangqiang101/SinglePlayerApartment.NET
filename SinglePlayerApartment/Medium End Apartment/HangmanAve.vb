...
Public Class HangmanAve
    ...
    Public Shared Owner As String = ReadCfgValue("HAowner", saveFile3)
    Public Shared _Name As String = "Hangman Avenue "
    Public Shared Desc As String = "Crazy movie director across the road? Check. Astronomically over-priced property where your car has more square footage than you do? Check. If you're looking for the full Vinewood Hills experience, this modest home ticks all the boxes. Includes 10-car garage."
    Public Shared Unit As String = "4"
    Public Shared Cost As Integer = 175000
    Public Shared _Blip As Blip
    Public Shared Blip2 As Blip
    Public Shared Entrance As Vector3 = New Vector3(-1405.445, 526.9388, 123.8313)
    ...
    Public Shared Teleport2 As Vector3 = New Vector3(-1406.652, 533.3694, 122.9286)
    ...
    Public Shared _Garage As Vector3 = New Vector3(-1409.864, 540.1284, 122.5761)
    Public Shared GarageOut As Vector3 = New Vector3(-1421.402, 535.7197, 120.7177)
    Public Shared GarageOutHeading As Single = 111.9388
    ...
    Public Shared CameraPos As Vector3 = New Vector3(-1437.455, 533.4254, 122.9885)
    Public Shared CameraRot As Vector3 = New Vector3(-4.026862, 0, -94.79375)
    ...
    Public Sub New()
        Try
            If ReadCfgValue("HangmanAve", settingFile) = "Enable" Then
                _Name = ReadCfgValue("HangmanAveName", langFile)
                Desc = ReadCfgValue("HangmanAveDesc", langFile)
    ...
    Public Sub ItemSelectHandler(sender As UIMenu, selectedItem As UIMenuItem, index As Integer)
        Try
            ...
            ElseIf selectedItem.Text = SellApt Then
                'Sell Apt
                ExitMenu.Visible = False
                WriteCfgValue("HAowner", "None", saveFile3)
                SavePosition2()
                Game.FadeScreenOut(500)
                Wait(&H3E8)
            ...
            ElseIf selectedItem.Text = EnterGarage Then
                ...
                TenCarGarage.LoadGarageVechicles(Application.StartupPath & "\scripts\SinglePlayerApartment\Garage\hangman_ave\")
                TenCarGarage.CurrentPath = Application.StartupPath & "\scripts\SinglePlayerApartment\Garage\hangman_ave\"
                ExitMenu.Visible = False
                Wait(500)
                Game.FadeScreenIn(500)
        ...
        Try
            If selectedItem.Text = _Name & Unit AndAlso selectedItem.RightBadge = UIMenuItem.BadgeStyle.None AndAlso selectedItem.RightLabel = "$" & Cost.ToString("N") AndAlso Owner = "None" Then
                ...
                If playerCash > Cost Then
                    WriteCfgValue("HAowner", playerName, saveFile3)
                    Game.FadeScreenOut(500)
                    Wait(&H3E8)
                    SinglePlayerApartment.player.Money = (playerCash - Cost)
                    Owner = playerName
    ...
    Public Sub GarageItemSelectHandler(sender As UIMenu, selectedItem As UIMenuItem, index As Integer)
        ...
        ElseIf selectedItem.Text = _Name & Unit & Garage AndAlso Not selectedItem.RightBadge = UIMenuItem.BadgeStyle.None AndAlso playerPed.IsInVehicle Then
            ...
            Dim path As String = Application.StartupPath & "\scripts\SinglePlayerApartment\Garage\hangman_ave\"
            ...
            Else
                TenCarGarage.LoadGarageVechicles(Application.StartupPath & "\scripts\SinglePlayerApartment\Garage\hangman_ave\")
                TenCarGarage.SaveGarageVehicle(Application.StartupPath & "\scripts\SinglePlayerApartment\Garage\hangman_ave\")
            End If
        End If
    End Sub

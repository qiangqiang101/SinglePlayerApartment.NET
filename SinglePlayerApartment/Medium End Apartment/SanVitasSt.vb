...
Public Class SanVitasSt
    ...
    Public Shared Owner As String = ReadCfgValue("SVSowner", saveFile3)
    Public Shared _Name As String = "1561 San Vitas Street Apt. "
    Public Shared Desc As String = "Original features! This cozy apartment in West Vinewood had only one owner, who didn't update a single thing since he moved in there 40 years ago and then passed away - it was days before anyone noticed. Includes 2-car garage. Includes 10-car garage."
    Public Shared Unit As String = "2"
    Public Shared Cost As Integer = 99000
    Public Shared _Blip As Blip
    Public Shared Blip2 As Blip
    Public Shared Entrance As Vector3 = New Vector3(-200.6851, 186.0549, 80.50522)
    ...
    Public Shared Teleport2 As Vector3 = New Vector3(-205.4685, 184.4087, 80.32763)
    ...
    Public Shared _Garage As Vector3 = New Vector3(-205.952, 192.6613, 79.88345)
    Public Shared GarageOut As Vector3 = New Vector3(-213.1964, 193.2091, 80.66739)
    Public Shared GarageOutHeading As Single = 82.44815
    ...
    Public Shared CameraPos As Vector3 = New Vector3(-227.7641, 201.8866, 86.85343)
    Public Shared CameraRot As Vector3 = New Vector3(-4.676774, 0, -109.3161)
    ...
    Public Sub New()
        Try
            If ReadCfgValue("SanVitasSt", settingFile) = "Enable" Then
                _Name = ReadCfgValue("SanVitasStName", langFile)
                Desc = ReadCfgValue("SanVitasStDesc", langFile)
    ...
    Public Sub ItemSelectHandler(sender As UIMenu, selectedItem As UIMenuItem, index As Integer)
        Try
            ...
            ElseIf selectedItem.Text = SellApt Then
                'Sell Apt
                ExitMenu.Visible = False
                WriteCfgValue("SVSowner", "None", saveFile3)
                SavePosition2()
                Game.FadeScreenOut(500)
                Wait(&H3E8)
            ...
            ElseIf selectedItem.Text = EnterGarage Then
                ...
                TenCarGarage.LoadGarageVechicles(Application.StartupPath & "\scripts\SinglePlayerApartment\Garage\san_vitas_st\")
                TenCarGarage.CurrentPath = Application.StartupPath & "\scripts\SinglePlayerApartment\Garage\san_vitas_st\"
                ExitMenu.Visible = False
                Wait(500)
                Game.FadeScreenIn(500)
        ...
        Try
            If selectedItem.Text = _Name & Unit AndAlso selectedItem.RightBadge = UIMenuItem.BadgeStyle.None AndAlso selectedItem.RightLabel = "$" & Cost.ToString("N") AndAlso Owner = "None" Then
                ...
                If playerCash > Cost Then
                    WriteCfgValue("SVSowner", playerName, saveFile3)
                    Game.FadeScreenOut(500)
                    Wait(&H3E8)
                    SinglePlayerApartment.player.Money = (playerCash - Cost)
                    Owner = playerName
    ...
    Public Sub GarageItemSelectHandler(sender As UIMenu, selectedItem As UIMenuItem, index As Integer)
        ...
        ElseIf selectedItem.Text = _Name & Unit & Garage AndAlso Not selectedItem.RightBadge = UIMenuItem.BadgeStyle.None AndAlso playerPed.IsInVehicle Then
            ...
            Dim path As String = Application.StartupPath & "\scripts\SinglePlayerApartment\Garage\san_vitas_st\"
            ...
            Else
                TenCarGarage.LoadGarageVechicles(Application.StartupPath & "\scripts\SinglePlayerApartment\Garage\san_vitas_st\")
                TenCarGarage.SaveGarageVehicle(Application.StartupPath & "\scripts\SinglePlayerApartment\Garage\san_vitas_st\")
            End If
        End If
    End Sub

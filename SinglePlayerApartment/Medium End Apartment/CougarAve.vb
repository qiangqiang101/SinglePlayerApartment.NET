...
Public Class CougarAve
    ...
    Public Shared Owner As String = ReadCfgValue("CAowner", saveFile3)
    Public Shared _Name As String = "0069 Cougar Avenue Apt. "
    Public Shared Desc As String = "The fixer-upper offers stunning views of the cemetery to at once remind you of your mortality and motive you to get your act together and buy a better apartment one day. Includes 10-car garage."
    Public Shared Unit As String = "19"
    Public Shared Cost As Integer = 112000
    Public Shared _Blip As Blip
    Public Shared Blip2 As Blip
    Public Shared Entrance As Vector3 = New Vector3(-1533.488, -326.8141, 47.91118)
    ...
    Public Shared Teleport2 As Vector3 = New Vector3(-1535.237, -325.281, 47.48159)
    ...
    Public Shared _Garage As Vector3 = New Vector3(-1530.807, -346.3962, 44.66446)
    Public Shared GarageOut As Vector3 = New Vector3(-1536.455, -352.6137, 44.54288)
    Public Shared GarageOutHeading As Single = 135.3604
    ...
    Public Shared CameraPos As Vector3 = New Vector3(-1563.921, -321.3005, 51.06629)
    Public Shared CameraRot As Vector3 = New Vector3(-4.889933, 0, -100.0785)
    ...
    Public Sub New()
        Try
            If ReadCfgValue("CougarAve", settingFile) = "Enable" Then
                _Name = ReadCfgValue("CougarName", langFile)
                Desc = ReadCfgValue("CougarDesc", langFile)
    ...
    Public Sub ItemSelectHandler(sender As UIMenu, selectedItem As UIMenuItem, index As Integer)
        Try
            ...
            ElseIf selectedItem.Text = SellApt Then
                'Sell Apt
                ExitMenu.Visible = False
                WriteCfgValue("CAowner", "None", saveFile3)
                SavePosition2()
                Game.FadeScreenOut(500)
                Wait(&H3E8)
            ...
            ElseIf selectedItem.Text = EnterGarage Then
                ...
                TenCarGarage.LoadGarageVechicles(Application.StartupPath & "\scripts\SinglePlayerApartment\Garage\cougar_ave\")
                TenCarGarage.CurrentPath = Application.StartupPath & "\scripts\SinglePlayerApartment\Garage\cougar_ave\"
                ExitMenu.Visible = False
                Wait(500)
                Game.FadeScreenIn(500)
        ...
        Try
            If selectedItem.Text = _Name & Unit AndAlso selectedItem.RightBadge = UIMenuItem.BadgeStyle.None AndAlso selectedItem.RightLabel = "$" & Cost.ToString("N") AndAlso Owner = "None" Then
                ...
                If playerCash > Cost Then
                    WriteCfgValue("CAowner", playerName, saveFile3)
                    Game.FadeScreenOut(500)
                    Wait(&H3E8)
                    SinglePlayerApartment.player.Money = (playerCash - Cost)
                    Owner = playerName
    ...
    Public Sub GarageItemSelectHandler(sender As UIMenu, selectedItem As UIMenuItem, index As Integer)
        ...
        ElseIf selectedItem.Text = _Name & Unit & Garage AndAlso Not selectedItem.RightBadge = UIMenuItem.BadgeStyle.None AndAlso playerPed.IsInVehicle Then
            ...
            Dim path As String = Application.StartupPath & "\scripts\SinglePlayerApartment\Garage\cougar_ave\"
            ...
            Else
                TenCarGarage.LoadGarageVechicles(Application.StartupPath & "\scripts\SinglePlayerApartment\Garage\cougar_ave\")
                TenCarGarage.SaveGarageVehicle(Application.StartupPath & "\scripts\SinglePlayerApartment\Garage\cougar_ave\")
            End If
        End If
    End Sub

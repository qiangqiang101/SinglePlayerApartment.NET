...
Public Class ProcopioDr4401
    ...
    Public Shared Teleport2 As Vector3 = New Vector3(-305.5824, 6330.911, 32.48935)
    ...
    Public Shared _Garage As Vector3 = New Vector3(-294.8063, 6338.88, 32.00024)
    Public Shared GarageOut As Vector3 = New Vector3(-296.2461, 6340.683, 31.76276)
    Public Shared GarageOutHeading As Single = 44.08249
    ...
    Public Shared CameraPos As Vector3 = New Vector3(-304.3051, 6344.134, 33.43044)
    Public Shared CameraRot As Vector3 = New Vector3(-6.942835, 0, -170.2991)
    ...
    Public Sub New()
        Try
            If ReadCfgValue("4401ProcopioDr", settingFile) = "Enable" Then
                _Name = ReadCfgValue("4401ProcopioDrName", langFile)
                Desc = ReadCfgValue("4401ProcopioDrDesc", langFile)
    ...
    Public Sub ItemSelectHandler(sender As UIMenu, selectedItem As UIMenuItem, index As Integer)
        Try
            ...
            ElseIf selectedItem.Text = SellApt Then
                'Sell Apt
                ExitMenu.Visible = False
                WriteCfgValue("4401PDowner", "None", saveFile3)
                SavePosition2()
                Game.FadeScreenOut(500)
                Wait(&H3E8)
            ...
            ElseIf selectedItem.Text = EnterGarage Then
                ...
                TenCarGarage.LoadGarageVechicles(Application.StartupPath & "\scripts\SinglePlayerApartment\Garage\4401_procopio_dr\")
                TenCarGarage.CurrentPath = Application.StartupPath & "\scripts\SinglePlayerApartment\Garage\4401_procopio_dr\"
                ExitMenu.Visible = False
                Wait(500)
                Game.FadeScreenIn(500)
        ...
        Try
            If selectedItem.Text = _Name & Unit AndAlso selectedItem.RightBadge = UIMenuItem.BadgeStyle.None AndAlso selectedItem.RightLabel = "$" & Cost.ToString("N") AndAlso Owner = "None" Then
                ...
                If playerCash > Cost Then
                    WriteCfgValue("4401PDowner", playerName, saveFile3)
                    Game.FadeScreenOut(500)
                    Wait(&H3E8)
                    SinglePlayerApartment.player.Money = (playerCash - Cost)
                    Owner = playerName
    ...
    Public Sub GarageItemSelectHandler(sender As UIMenu, selectedItem As UIMenuItem, index As Integer)
        ...
        ElseIf selectedItem.Text = _Name & Unit & Garage AndAlso Not selectedItem.RightBadge = UIMenuItem.BadgeStyle.None AndAlso playerPed.IsInVehicle Then
            ...
            Dim path As String = Application.StartupPath & "\scripts\SinglePlayerApartment\Garage\4401_procopio_dr\"
            ...
            Else
                TenCarGarage.LoadGarageVechicles(Application.StartupPath & "\scripts\SinglePlayerApartment\Garage\4401_procopio_dr\")
                TenCarGarage.SaveGarageVehicle(Application.StartupPath & "\scripts\SinglePlayerApartment\Garage\4401_procopio_dr\")
            End If
        End If
    End Sub

...
Public Class TheRoyale
    ...
    Public Shared Owner As String = ReadCfgValue("TRowner", saveFile3)
    Public Shared _Name As String = "The Royale Apt. "
    ...
    Public Shared Cost As Integer = 125000
    Public Shared _Blip As Blip
    Public Shared Blip2 As Blip
    Public Shared Entrance As Vector3 = New Vector3(-197.7387, 85.69609, 69.75623)
    ...
    Public Shared Teleport2 As Vector3 = New Vector3(-197.6289, 90.04182, 69.65993)
    ...
    Public Shared _Garage As Vector3 = New Vector3(-212.6948, 73.81252, 66.74328)
    Public Shared GarageOut As Vector3 = New Vector3(-215.8855, 75.07529, 66.78372)
    Public Shared GarageOutHeading As Single = 81.58614
    ...
    Public Shared CameraPos As Vector3 = New Vector3(-194.8486, 123.9623, 71.46825)
    Public Shared CameraRot As Vector3 = New Vector3(1.435651, 0, -168.6253)
    ...
    Public Sub New()
        Try
            If ReadCfgValue("TheRoyale", settingFile) = "Enable" Then
                _Name = ReadCfgValue("TheRoyaleName", langFile)
                Desc = ReadCfgValue("TheRoyaleDesc", langFile)
    ...
    Public Sub ItemSelectHandler(sender As UIMenu, selectedItem As UIMenuItem, index As Integer)
        Try
            ...
            ElseIf selectedItem.Text = SellApt Then
                'Sell Apt
                ExitMenu.Visible = False
                WriteCfgValue("TRowner", "None", saveFile3)
                SavePosition2()
                Game.FadeScreenOut(500)
                Wait(&H3E8)
            ...
            ElseIf selectedItem.Text = EnterGarage Then
                ...
                TenCarGarage.LoadGarageVechicles(Application.StartupPath & "\scripts\SinglePlayerApartment\Garage\the_royale\")
                TenCarGarage.CurrentPath = Application.StartupPath & "\scripts\SinglePlayerApartment\Garage\the_royale\"
                ExitMenu.Visible = False
                Wait(500)
                Game.FadeScreenIn(500)
        ...
        Try
            If selectedItem.Text = _Name & Unit AndAlso selectedItem.RightBadge = UIMenuItem.BadgeStyle.None AndAlso selectedItem.RightLabel = "$" & Cost.ToString("N") AndAlso Owner = "None" Then
                ...
                If playerCash > Cost Then
                    WriteCfgValue("TRowner", playerName, saveFile3)
                    Game.FadeScreenOut(500)
                    Wait(&H3E8)
                    SinglePlayerApartment.player.Money = (playerCash - Cost)
                    Owner = playerName
    ...
    Public Sub GarageItemSelectHandler(sender As UIMenu, selectedItem As UIMenuItem, index As Integer)
        ...
        ElseIf selectedItem.Text = _Name & Unit & Garage AndAlso Not selectedItem.RightBadge = UIMenuItem.BadgeStyle.None AndAlso playerPed.IsInVehicle Then
            ...
            Dim path As String = Application.StartupPath & "\scripts\SinglePlayerApartment\Garage\the_royale\"
            ...
            Else
                TenCarGarage.LoadGarageVechicles(Application.StartupPath & "\scripts\SinglePlayerApartment\Garage\the_royale\")
                TenCarGarage.SaveGarageVehicle(Application.StartupPath & "\scripts\SinglePlayerApartment\Garage\the_royale\")
            End If
        End If
    End Sub

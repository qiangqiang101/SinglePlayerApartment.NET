...
Public Class SouthRockfordDrive0325
    ...
    Public Shared Owner As String = ReadCfgValue("0325SRDowner", saveFile3)
    Public Shared _Name As String = "0325 South Rockford Drive Apt. "
    Public Shared Desc As String = "Location is in the eye of the beholder! Some might call this a busy traffic junction, we call it a Commuter's Dream! Some might call this Little Seoul, we call it Vespucci so we can up the price! Includes 10-car garage."
    Public Shared Unit As String = "1"
    Public Shared Cost As Integer = 137000
    Public Shared _Blip As Blip
    Public Shared Blip2 As Blip
    Public Shared Entrance As Vector3 = New Vector3(-831.4216, -862.641, 20.68967)
    ...
    Public Shared Teleport2 As Vector3 = New Vector3(-831.6166, -856.5034, 19.59702)
    ...
    Public Shared _Garage As Vector3 = New Vector3(-758.8065, -870.7308, 20.9393)
    Public Shared GarageOut As Vector3 = New Vector3(-755.0645, -870.7145, 21.18062)
    Public Shared GarageOutHeading As Single = 267.8936
    ...
    Public Shared CameraPos As Vector3 = New Vector3(-846.1815, -821.6712, 21.12708)
    Public Shared CameraRot As Vector3 = New Vector3(9.139385, 0, -142.4772)
    ...
    Public Sub New()
        Try
            If ReadCfgValue("0325SouthRockfordDr", settingFile) = "Enable" Then
                _Name = ReadCfgValue("0325SouthRockfordName", langFile)
                Desc = ReadCfgValue("0325SouthRockfordDesc", langFile)
    ...
    Public Sub ItemSelectHandler(sender As UIMenu, selectedItem As UIMenuItem, index As Integer)
        Try
            ...
            ElseIf selectedItem.Text = SellApt Then
                'Sell Apt
                ExitMenu.Visible = False
                WriteCfgValue("0325SRDowner", "None", saveFile3)
                SavePosition2()
                Game.FadeScreenOut(500)
                Wait(&H3E8)
            ...
            ElseIf selectedItem.Text = EnterGarage Then
                ...
                TenCarGarage.LoadGarageVechicles(Application.StartupPath & "\scripts\SinglePlayerApartment\Garage\0325_south_rockford_dr\")
                TenCarGarage.CurrentPath = Application.StartupPath & "\scripts\SinglePlayerApartment\Garage\0325_south_rockford_dr\"
                ExitMenu.Visible = False
                Wait(500)
                Game.FadeScreenIn(500)
        ...
        Try
            If selectedItem.Text = _Name & Unit AndAlso selectedItem.RightBadge = UIMenuItem.BadgeStyle.None AndAlso selectedItem.RightLabel = "$" & Cost.ToString("N") AndAlso Owner = "None" Then
                ...
                If playerCash > Cost Then
                    WriteCfgValue("0325SRDowner", playerName, saveFile3)
                    Game.FadeScreenOut(500)
                    Wait(&H3E8)
                    SinglePlayerApartment.player.Money = (playerCash - Cost)
                    Owner = playerName
    ...
    Public Sub GarageItemSelectHandler(sender As UIMenu, selectedItem As UIMenuItem, index As Integer)
        ...
        ElseIf selectedItem.Text = _Name & Unit & Garage AndAlso Not selectedItem.RightBadge = UIMenuItem.BadgeStyle.None AndAlso playerPed.IsInVehicle Then
            ...
            Dim path As String = Application.StartupPath & "\scripts\SinglePlayerApartment\Garage\0325_south_rockford_dr\"
            ...
            Else
                TenCarGarage.LoadGarageVechicles(Application.StartupPath & "\scripts\SinglePlayerApartment\Garage\0325_south_rockford_dr\")
                TenCarGarage.SaveGarageVehicle(Application.StartupPath & "\scripts\SinglePlayerApartment\Garage\0325_south_rockford_dr\")
            End If
        End If
    End Sub

...
Public Class PowerSt
    ...
    Public Shared Owner As String = ReadCfgValue("PSowner", saveFile3)
    Public Shared _Name As String = "1162 Power Street Apt. "
    Public Shared Desc As String = "Located steps away from a skate park, this cute-as-a-button one-bedroom in Hawick is perfect for families with teenage children or tragic 30-something hipsters with fixies. Includes 10-car garage."
    Public Shared Unit As String = "3"
    Public Shared Cost As Integer = 130000
    Public Shared _Blip As Blip
    Public Shared Blip2 As Blip
    Public Shared Entrance As Vector3 = New Vector3(285.9683, -160.4879, 64.61704)
    ...
    Public Shared Teleport2 As Vector3 = New Vector3(282.245, -159.5781, 63.62236)
    ...
    Public Shared _Garage As Vector3 = New Vector3(281.59, -146.9051, 64.62709)
    Public Shared GarageOut As Vector3 = New Vector3(271.4526, -143.1953, 64.92351)
    Public Shared GarageOutHeading As Single = 71.11879
    ...
    Public Shared CameraPos As Vector3 = New Vector3(247.5116, -143.1925, 67.63675)
    Public Shared CameraRot As Vector3 = New Vector3(1.717242, 0, -99.06012)
    ...
    Public Sub New()
        Try
            If ReadCfgValue("PowerSt", settingFile) = "Enable" Then
                _Name = ReadCfgValue("PowerStName", langFile)
                Desc = ReadCfgValue("PowerStDesc", langFile)
    ...
    Public Sub ItemSelectHandler(sender As UIMenu, selectedItem As UIMenuItem, index As Integer)
        Try
            ...
            ElseIf selectedItem.Text = SellApt Then
                'Sell Apt
                ExitMenu.Visible = False
                WriteCfgValue("PSowner", "None", saveFile3)
                SavePosition2()
                Game.FadeScreenOut(500)
                Wait(&H3E8)
            ...
            ElseIf selectedItem.Text = EnterGarage Then
                ...
                TenCarGarage.LoadGarageVechicles(Application.StartupPath & "\scripts\SinglePlayerApartment\Garage\power_st\")
                TenCarGarage.CurrentPath = Application.StartupPath & "\scripts\SinglePlayerApartment\Garage\power_st\"
                ExitMenu.Visible = False
                Wait(500)
                Game.FadeScreenIn(500)
        ...
        Try
            If selectedItem.Text = _Name & Unit AndAlso selectedItem.RightBadge = UIMenuItem.BadgeStyle.None AndAlso selectedItem.RightLabel = "$" & Cost.ToString("N") AndAlso Owner = "None" Then
                ...
                If playerCash > Cost Then
                    WriteCfgValue("PSowner", playerName, saveFile3)
                    Game.FadeScreenOut(500)
                    Wait(&H3E8)
                    SinglePlayerApartment.player.Money = (playerCash - Cost)
                    Owner = playerName
    ...
    Public Sub GarageItemSelectHandler(sender As UIMenu, selectedItem As UIMenuItem, index As Integer)
        ...
        ElseIf selectedItem.Text = _Name & Unit & Garage AndAlso Not selectedItem.RightBadge = UIMenuItem.BadgeStyle.None AndAlso playerPed.IsInVehicle Then
            ...
            Dim path As String = Application.StartupPath & "\scripts\SinglePlayerApartment\Garage\power_st\"
            ...
            Else
                TenCarGarage.LoadGarageVechicles(Application.StartupPath & "\scripts\SinglePlayerApartment\Garage\power_st\")
                TenCarGarage.SaveGarageVehicle(Application.StartupPath & "\scripts\SinglePlayerApartment\Garage\power_st\")
            End If
        End If
    End Sub

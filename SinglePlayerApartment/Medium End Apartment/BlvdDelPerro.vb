...
Public Class BlvdDelPerro
    ...
    Public Shared Owner As String = ReadCfgValue("BDPowner", saveFile3)
    Public Shared _Name As String = "1115 Boulevard Del Perro Apt. "
    Public Shared Desc As String = "With a funky retro décor and carpeted thoughout, you can literally smell the history in this Del Perro apartment that features an almost unobstracted ocean view for an almost unbeatable price. Includes 10-car garage."
    Public Shared Unit As String = "18"
    Public Shared Cost As Integer = 93000
    Public Shared _Blip As Blip
    Public Shared Blip2 As Blip
    Public Shared Entrance As Vector3 = New Vector3(-1606.128, -432.6062, 40.43186)
    ...
    Public Shared Teleport2 As Vector3 = New Vector3(-1610.868, -428.8814, 40.46698)
    ...
    Public Shared _Garage As Vector3 = New Vector3(-1608.53, -451.0937, 37.58678)
    Public Shared GarageOut As Vector3 = New Vector3(-1611.859, -454.9521, 37.49269)
    Public Shared GarageOutHeading As Single = 138.179
    ...
    Public Shared CameraPos As Vector3 = New Vector3(-1643.548, -435.6621, 41.09145)
    Public Shared CameraRot As Vector3 = New Vector3(8.244346, 0, -86.32664)
    ...
    Public Sub New()
        Try
            If ReadCfgValue("BlvdDelPerro", settingFile) = "Enable" Then
                _Name = ReadCfgValue("BlvdDelPerroName", langFile)
                Desc = ReadCfgValue("BlvdDelPerroDesc", langFile)
    ...
    Public Sub ItemSelectHandler(sender As UIMenu, selectedItem As UIMenuItem, index As Integer)
        Try
            ...
            ElseIf selectedItem.Text = SellApt Then
                'Sell Apt
                ExitMenu.Visible = False
                WriteCfgValue("BDPowner", "None", saveFile3)
                SavePosition2()
                Game.FadeScreenOut(500)
                Wait(&H3E8)
            ...
            ElseIf selectedItem.Text = EnterGarage Then
                ...
                TenCarGarage.LoadGarageVechicles(Application.StartupPath & "\scripts\SinglePlayerApartment\Garage\blvd_del_perro\")
                TenCarGarage.CurrentPath = Application.StartupPath & "\scripts\SinglePlayerApartment\Garage\blvd_del_perro\"
                ExitMenu.Visible = False
                Wait(500)
                Game.FadeScreenIn(500)
        ...
        Try
            If selectedItem.Text = _Name & Unit AndAlso selectedItem.RightBadge = UIMenuItem.BadgeStyle.None AndAlso selectedItem.RightLabel = "$" & Cost.ToString("N") AndAlso Owner = "None" Then
                ...
                If playerCash > Cost Then
                    WriteCfgValue("BDPowner", playerName, saveFile3)
                    Game.FadeScreenOut(500)
                    Wait(&H3E8)
                    SinglePlayerApartment.player.Money = (playerCash - Cost)
                    Owner = playerName
    ...
    Public Sub GarageItemSelectHandler(sender As UIMenu, selectedItem As UIMenuItem, index As Integer)
        ...
        ElseIf selectedItem.Text = _Name & Unit & Garage AndAlso Not selectedItem.RightBadge = UIMenuItem.BadgeStyle.None AndAlso playerPed.IsInVehicle Then
            ...
            Dim path As String = Application.StartupPath & "\scripts\SinglePlayerApartment\Garage\blvd_del_perro\"
            ...
            Else
                TenCarGarage.LoadGarageVechicles(Application.StartupPath & "\scripts\SinglePlayerApartment\Garage\blvd_del_perro\")
                TenCarGarage.SaveGarageVehicle(Application.StartupPath & "\scripts\SinglePlayerApartment\Garage\blvd_del_perro\")
            End If
        End If
    End Sub

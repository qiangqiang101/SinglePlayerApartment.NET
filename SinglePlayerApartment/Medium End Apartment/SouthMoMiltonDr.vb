...
Public Class SouthMoMiltonDr
    ...
    Public Shared Owner As String = ReadCfgValue("SMMowner", saveFile3)
    Public Shared _Name As String = "0504 South Mo Milton Drive Apt. "
    Public Shared Desc As String = "This modern, renovated one-bedroom is in a well-maintained building in a great West Vinewood location. Buy now at the bottom of the market! Property values can't go any lower! We're absolutely sure this time!  Includes 10-car garage."
    Public Shared Unit As String = "1"
    Public Shared Cost As Integer = 141000
    Public Shared _Blip As Blip
    Public Shared Blip2 As Blip
    Public Shared Entrance As Vector3 = New Vector3(-627.7245, 169.6668, 61.16204)
    ...
    Public Shared Teleport2 As Vector3 = New Vector3(-633.7015, 169.4392, 61.22641)
    ...
    Public Shared _Garage As Vector3 = New Vector3(-630.657, 152.3768, 56.41848)
    Public Shared GarageOut As Vector3 = New Vector3(-638.4281, 152.3656, 57.24699)
    Public Shared GarageOutHeading As Single = 89.08953
    ...
    Public Shared CameraPos As Vector3 = New Vector3(-663.4779, 162.9781, 62.82269)
    Public Shared CameraRot As Vector3 = New Vector3(7.656792, 0, -92.89036)
    ...
    Public Sub New()
        Try
            If ReadCfgValue("SouthMoMiltonDr", settingFile) = "Enable" Then
                _Name = ReadCfgValue("SouthMoMiltonName", langFile)
                Desc = ReadCfgValue("SouthMoMiltonDesc", langFile)
    ...
    Public Sub ItemSelectHandler(sender As UIMenu, selectedItem As UIMenuItem, index As Integer)
        Try
            ...
            ElseIf selectedItem.Text = SellApt Then
                'Sell Apt
                ExitMenu.Visible = False
                WriteCfgValue("SMMowner", "None", saveFile3)
                SavePosition2()
                Game.FadeScreenOut(500)
                Wait(&H3E8)
            ...
            ElseIf selectedItem.Text = EnterGarage Then
                ...
                TenCarGarage.LoadGarageVechicles(Application.StartupPath & "\scripts\SinglePlayerApartment\Garage\south_mo_milton_dr\")
                TenCarGarage.CurrentPath = Application.StartupPath & "\scripts\SinglePlayerApartment\Garage\south_mo_milton_dr\"
                ExitMenu.Visible = False
                Wait(500)
                Game.FadeScreenIn(500)
        ...
        Try
            If selectedItem.Text = _Name & Unit AndAlso selectedItem.RightBadge = UIMenuItem.BadgeStyle.None AndAlso selectedItem.RightLabel = "$" & Cost.ToString("N") AndAlso Owner = "None" Then
                ...
                If playerCash > Cost Then
                    WriteCfgValue("SMMowner", playerName, saveFile3)
                    Game.FadeScreenOut(500)
                    Wait(&H3E8)
                    SinglePlayerApartment.player.Money = (playerCash - Cost)
                    Owner = playerName
    ...
    Public Sub GarageItemSelectHandler(sender As UIMenu, selectedItem As UIMenuItem, index As Integer)
        ...
        ElseIf selectedItem.Text = _Name & Unit & Garage AndAlso Not selectedItem.RightBadge = UIMenuItem.BadgeStyle.None AndAlso playerPed.IsInVehicle Then
            ...
            Dim path As String = Application.StartupPath & "\scripts\SinglePlayerApartment\Garage\south_mo_milton_dr\"
            ...
            Else
                TenCarGarage.LoadGarageVechicles(Application.StartupPath & "\scripts\SinglePlayerApartment\Garage\south_mo_milton_dr\")
                TenCarGarage.SaveGarageVehicle(Application.StartupPath & "\scripts\SinglePlayerApartment\Garage\south_mo_milton_dr\")
            End If
        End If
    End Sub

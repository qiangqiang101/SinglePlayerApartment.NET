...
Public Class ProsperitySt
    ...
    Public Shared Owner As String = ReadCfgValue("PPSowner", saveFile3)
    Public Shared _Name As String = "1237 Prosperity Street Apt. "
    Public Shared Desc As String = "With both Wigwam and Up-n-Atom right on your doorstep, burger enthusiasts will be spoiled for choice at this apartment located in Del Perro or Morningwood, depending on which side of the building you stand.  Includes 10-car garage."
    Public Shared Unit As String = "21"
    Public Shared Cost As Integer = 105000
    Public Shared _Blip As Blip
    Public Shared Blip2 As Blip
    Public Shared Entrance As Vector3 = New Vector3(-1564.456, -406.2599, 42.38398)
    ...
    Public Shared Teleport2 As Vector3 = New Vector3(-1562.17, -408.0945, 42.38398)
    ...
    Public Shared _Garage As Vector3 = New Vector3(-1554.318, -402.5234, 41.53171)
    Public Shared GarageOut As Vector3 = New Vector3(-1548.194, -407.8083, 41.50047)
    Public Shared GarageOutHeading As Single = 228.1096
    ...
    Public Shared CameraPos As Vector3 = New Vector3(-1510.861, -407.8669, 42.94849)
    Public Shared CameraRot As Vector3 = New Vector3(6.705585, 0, 82.56407)
    ...
    Public Sub New()
        Try
            If ReadCfgValue("ProsperitySt", settingFile) = "Enable" Then
                _Name = ReadCfgValue("ProsperityStName", langFile)
                Desc = ReadCfgValue("ProsperityStDesc", langFile)
    ...
    Public Sub ItemSelectHandler(sender As UIMenu, selectedItem As UIMenuItem, index As Integer)
        Try
            ...
            ElseIf selectedItem.Text = SellApt Then
                'Sell Apt
                ExitMenu.Visible = False
                WriteCfgValue("PPSowner", "None", saveFile3)
                SavePosition2()
                Game.FadeScreenOut(500)
                Wait(&H3E8)
            ...
            ElseIf selectedItem.Text = EnterGarage Then
                ...
                TenCarGarage.LoadGarageVechicles(Application.StartupPath & "\scripts\SinglePlayerApartment\Garage\prosperity_st\")
                TenCarGarage.CurrentPath = Application.StartupPath & "\scripts\SinglePlayerApartment\Garage\prosperity_st\"
                ExitMenu.Visible = False
                Wait(500)
                Game.FadeScreenIn(500)
        ...
        Try
            If selectedItem.Text = _Name & Unit AndAlso selectedItem.RightBadge = UIMenuItem.BadgeStyle.None AndAlso selectedItem.RightLabel = "$" & Cost.ToString("N") AndAlso Owner = "None" Then
                ...
                If playerCash > Cost Then
                    WriteCfgValue("PPSowner", playerName, saveFile3)
                    Game.FadeScreenOut(500)
                    Wait(&H3E8)
                    SinglePlayerApartment.player.Money = (playerCash - Cost)
                    Owner = playerName
    ...
    Public Sub GarageItemSelectHandler(sender As UIMenu, selectedItem As UIMenuItem, index As Integer)
        ...
        ElseIf selectedItem.Text = _Name & Unit & Garage AndAlso Not selectedItem.RightBadge = UIMenuItem.BadgeStyle.None AndAlso playerPed.IsInVehicle Then
            ...
            Dim path As String = Application.StartupPath & "\scripts\SinglePlayerApartment\Garage\prosperity_st\"
            ...
            Else
                TenCarGarage.LoadGarageVechicles(Application.StartupPath & "\scripts\SinglePlayerApartment\Garage\prosperity_st\")
                TenCarGarage.SaveGarageVehicle(Application.StartupPath & "\scripts\SinglePlayerApartment\Garage\prosperity_st\")
            End If
        End If
    End Sub
